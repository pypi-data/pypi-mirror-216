...
config = {
    ...
    'tensorrt_nlp':
        {
            'encoder': get_model(url='https://drive.google.com/u/3/uc?id=1iDPkpKDlauRkEZ3TjOjzEGIOLEMcwJc4&export=download',
                                 encoder=True),
            'decoder': get_model(url='https://drive.google.com/u/3/uc?id=1gCkrx-s7joOQvBi-kvhnpJuOJY4fxe9H&export=download',
                                 decoder=True)
        }
}
