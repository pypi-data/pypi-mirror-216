...
class FirstLevelReactCache(AbstractFirstLevelCache):
    def get_first_level_cache_md5(self, cache_factor):
        ...
        first_level_buffer += cache_factor.dev
        first_level_buffer += cache_factor.app_type
        first_level_buffer += cache_factor.js_template_commitid
        first_level_buffer += cache_factor.js_build_tool
        first_level_buffer += cache_factor.skin_file_md5

        return self.get_md5(first_level_buffer)

    def save_first_level_cache(self, npm_dto, cache_md5):
        return self.get_js_package_cache(npm_dto, cache_md5, "target/react")
