...
from es7s.shared.file import IFileIconRenderer, FileIconRendererFactory, IFile
from es7s.shared.path import LS_PATH
...
@cli_option(
    ...
    "--grid",
    is_flag=True,
    help="Display only names and icons as a grid instead of a list.",
)
@cli_option(
    "-h",
    "--hard-links",
