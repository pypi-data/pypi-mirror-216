...
from es7s.shared.io import make_dummy_io, make_interceptor_io
from es7s.shared.threads import class_to_command_name, exit_gracefully
...
class GenericDemoComposer(IDemoComposer):
    def __init__(self, monitor: CoreMonitor):
        ...
        if get_logger().setup.display_monitor_debugging_markup:
