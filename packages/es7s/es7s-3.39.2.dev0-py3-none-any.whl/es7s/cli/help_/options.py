...
╚══════════════════╩════════╩════════╩════════╩════════╩════════╝\n\n
    ║ Stderr level ║̈́´WARN+´ │´INFO+´ │´DEBUG+´│´TRACE+´│ ´NONE´ │\n\n
    ║ Syslog level ║̈́´INFO+´ │´DEBUG+´│´TRACE+´│´TRACE+´│ ░░░░░░ │\n\n
    ...
    ENVIRONMENT_WO = [
        ...
        *[
        ...
        (
            ...
            "'/tmp/es7s-stdout' and '/tmp/es7sstderr'. Has the same effect as <cli.debug-io> config "
