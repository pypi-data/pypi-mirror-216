...
from coiote.v3.model.device_events import EventHandler, EventHandlerConfiguration, EventHandlerFilter, EventHandlerUpdateData, HandlerTestResult, HandlerType, WebhookConnectionConfig, WebhookFormat
    ...
    def create_influx_handler(self,
        ...
        configuration = EventHandlerConfiguration(
            ...
            connectionConfig=WebhookConnectionConfig(
                uri=f"https://{host}/api/v2/write?bucket={bucket_id}",
                additionalHeaders={
