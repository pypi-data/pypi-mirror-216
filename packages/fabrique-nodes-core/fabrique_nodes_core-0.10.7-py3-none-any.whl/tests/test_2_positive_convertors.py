...
def data_for_ports(request):
    if request.param == 'pet':
        jsons = pets_jsons
        schema = None
        expected_value = '''[{"id_": "root", "name": "", "type_": "object", "visible": true, "required": true, "special": false, "code": "", "schema_": ""}, {"id_": "name", "name": "name", "type_": "string", "visible": true, "required": true, "special": false, "code": "name", "schema_": ""}, {"id_": "age", "name": "age", "type_": "integer", "visible": true, "required": true, "special": false, "code": "age", "schema_": ""}, {"id_": "nickname", "name": "nickname", "type_": "string", "visible": true, "required": false, "special": false, "code": "nickname", "schema_": ""}, {"id_": "job", "name": "job", "type_": "object", "visible": true, "required": false, "special": false, "code": "job", "schema_": ""}, {"id_": "job.type", "name": "job.type", "type_": "string", "visible": true, "required": false, "special": true, "code": "job.type", "schema_": ""}, {"id_": "job.salary", "name": "job.salary", "type_": "integer", "visible": true, "required": false, "special": true, "code": "job.salary", "schema_": ""}, {"id_": "bones", "name": "bones", "type_": "array", "visible": true, "required": false, "special": false, "code": "bones", "schema_": ""}]'''  # noqa: E501
