...
class GemGemContentResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, artifacts=None, checksum=None, name=None, version=None, prerelease=None, dependencies=None, required_ruby_version=None, required_rubygems_version=None, local_vars_configuration=None):  # noqa: E501
