...
data_file = f'{work_dir}/data_preprocessed/{file_name}_norm.csv'
...
losses_norm = {'mse': 'median',     # Normalization strategy for each loss
               ...
               'dis': 1 / 100,
               'aux': 1 / 100}
weighting_strategy = False          # Whether to use relative weighting
...
grid_search(model=model, lr_list=lr_list, batch_size_list=batch_size_list, max_epochs=epochs,
            ...
            weigthing_strategy=weighting_strategy, losses_norm=losses_norm, seed=seed, norm_data=norm_data,
