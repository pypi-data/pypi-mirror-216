...
model_name = os.environ.get('model_name', 'aif_proj_boost_norm_log_rel_dyn_aux_dis_delayed_decay_exp')  # Model name
...
run_batch_effect_pipeline(model=model, adata=adata, batch_size=batch_size, epochs=epochs, lr=lr, beta_1=beta_1,
                          ...
                          projection_constraint=projection_constraint, scheduler=scheduler, start_decay=start_decay,
                          decay_factor=decay_factor, update_dis_freq=update_dis_freq, update_aux_freq=update_aux_freq)
