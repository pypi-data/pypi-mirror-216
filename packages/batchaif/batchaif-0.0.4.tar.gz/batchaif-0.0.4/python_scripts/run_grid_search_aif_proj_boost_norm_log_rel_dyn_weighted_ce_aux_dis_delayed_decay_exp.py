...
model_name = os.environ.get('model_name',                # Model name
                            'aif_proj_boost_norm_log_rel_dyn_weighted_ce_aux_dis_delayed_decay_exp')
...
projection_constraint = {'random': True,    # Whether to use projection constraints
                         'avg': True}
...
decay_factor = 0.999                # Decay factor for exponentional LR scheduler
