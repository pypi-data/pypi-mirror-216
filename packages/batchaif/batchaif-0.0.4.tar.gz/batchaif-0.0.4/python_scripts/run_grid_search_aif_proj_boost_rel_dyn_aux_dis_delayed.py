...
model_name = os.environ.get('model_name', 'aif_proj_boost_rel_dyn')  # Model name
...
update_dis_freq = 1 / 300       # Frequency at which to update GAN network
update_aux_freq = 1 / 300       # Frequency at which to update auxiliary network
