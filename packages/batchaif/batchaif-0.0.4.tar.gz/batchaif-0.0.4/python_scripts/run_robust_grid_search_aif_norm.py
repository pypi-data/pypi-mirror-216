...
model_name = os.environ.get('model_name', 'aif_norm')                   # Model name

# Dataset path, file's name and outputs directory name
root = f'{work_dir}/batch_effects_biomed/attribute-cVAEGAN/InData'
data_file = f'{work_dir}/batch_effects_biomed/data_preprocessed/{file_name}_norm.csv'
...
hyperparameters_file = f'{out_dir}/robust_hyperparameters_set.csv'
...
dynamic_ratio = 1                   # Percentage of the data to use for dynamic reweighting
...
robust_grid_search(model=model, lr_list=lr_list, batch_size_list=batch_size_list,
                   ...
                   max_epochs=epochs, label_projection=label_projection, n_samplings=n_samplings, n_labels=n_labels,
