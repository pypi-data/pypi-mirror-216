...
model_name = os.environ.get('model_name', 'aif_proj_boost_rel_dyn_decay_exp')  # Model name
...
run_batch_effect_pipeline(model=model, adata=adata, batch_size=batch_size, epochs=epochs, lr=lr, beta_1=beta_1,
                          ...
                          projection_constraint=projection_constraint, scheduler=scheduler, decay_factor=decay_factor,
