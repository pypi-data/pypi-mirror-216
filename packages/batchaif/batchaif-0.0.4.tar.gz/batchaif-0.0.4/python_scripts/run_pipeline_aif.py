...
from training_functions import run_batch_effect_pipeline
...
log_transfo = False             # Whether to use log1p transformation
...
weighting_strategy = None       # Whether to use relative weighting
...
run_batch_effect_pipeline(model=model, adata=adata, batch_size=batch_size, epochs=epochs, lr=lr, beta_1=beta_1,
                          ...
                          label_projection=label_projection, n_labels=n_labels, plot=plot, save=save, verbose=verbose,
                          print_every=print_every, device=device, early_stopping=early_stopping, min_epochs=min_epochs,
