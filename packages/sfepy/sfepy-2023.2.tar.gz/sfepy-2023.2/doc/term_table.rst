...
.. list-table:: Basic terms
   ...
   * - dw_biot
     ...
     - :ref:`the.ela <multi_physics-thermo_elasticity>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`bio <multi_physics-biot>`
   * - ev_biot_stress
   ...
   * - dw_diffusion
     ...
     - .. math::
            \int_{\Omega} K_{ij} \nabla_i q \nabla_j p
     - :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`poi.neu <diffusion-poisson_neumann>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`pie.ela <multi_physics-piezo_elastodynamic>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`bio <multi_physics-biot>`
   ...
   * - dw_div_grad
     ...
     - :ref:`nav.sto.iga <navier_stokes-navier_stokes2d_iga>`, :ref:`sta.nav.sto <navier_stokes-stabilized_navier_stokes>`, :ref:`nav.sto <navier_stokes-navier_stokes2d>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`nav.sto <navier_stokes-navier_stokes>`, :ref:`sto <navier_stokes-stokes>`
   * - dw_dot
     ...
     - :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`adv.1D <dg-advection_1D>`, :ref:`bal <large_deformation-balloon>`, :ref:`bur.2D <dg-burgers_2D>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`poi.fun <diffusion-poisson_functions>`, :ref:`bor <quantum-boron>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`lin.ela.dam <linear_elasticity-linear_elastic_damping>`, :ref:`tim.poi.exp <diffusion-time_poisson_explicit>`, :ref:`tim.hea.equ.mul.mat <diffusion-time_heat_equation_multi_material>`, :ref:`mod.ana.dec <linear_elasticity-modal_analysis_declarative>`, :ref:`hyd <quantum-hydrogen>`, :ref:`tim.poi <diffusion-time_poisson>`, :ref:`hel.apa <acoustics-helmholtz_apartment>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`adv.2D <dg-advection_2D>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`the.ele <multi_physics-thermal_electric>`, :ref:`tim.adv.dif <diffusion-time_advection_diffusion>`, :ref:`wel <quantum-well>`, :ref:`aco <acoustics-acoustics>`, :ref:`pie.ela <multi_physics-piezo_elastodynamic>`, :ref:`osc <quantum-oscillator>`
   * - dw_elastic_wave
   ...
   * - dw_integrate
     ...
     - :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`poi.neu <diffusion-poisson_neumann>`, :ref:`aco <acoustics-acoustics>`, :ref:`hel.apa <acoustics-helmholtz_apartment>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`tim.hea.equ.mul.mat <diffusion-time_heat_equation_multi_material>`
   * - ev_integrate_mat
   ...
   * - dw_laplace
     ...
     - .. math::
            \int_{\Omega} c \nabla q \cdot \nabla p
     - :ref:`poi.sho.syn <diffusion-poisson_short_syntax>`, :ref:`lap.1d <diffusion-laplace_1d>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`cub <diffusion-cube>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`bur.2D <dg-burgers_2D>`, :ref:`lap.flu.2d <diffusion-laplace_fluid_2d>`, :ref:`bor <quantum-boron>`, :ref:`poi.fun <diffusion-poisson_functions>`, :ref:`poi.iga <diffusion-poisson_iga>`, :ref:`poi.fie.dep.mat <diffusion-poisson_field_dependent_material>`, :ref:`lap.tim.ebc <diffusion-laplace_time_ebcs>`, :ref:`lap.cou.lcb <diffusion-laplace_coupling_lcbcs>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`tim.poi.exp <diffusion-time_poisson_explicit>`, :ref:`tim.hea.equ.mul.mat <diffusion-time_heat_equation_multi_material>`, :ref:`lap.2D <dg-laplace_2D>`, :ref:`hyd <quantum-hydrogen>`, :ref:`tim.poi <diffusion-time_poisson>`, :ref:`hel.apa <acoustics-helmholtz_apartment>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`poi.par.stu <diffusion-poisson_parametric_study>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`the.ele <multi_physics-thermal_electric>`, :ref:`tim.adv.dif <diffusion-time_advection_diffusion>`, :ref:`sin <diffusion-sinbc>`, :ref:`wel <quantum-well>`, :ref:`poi <diffusion-poisson>`, :ref:`aco <acoustics-acoustics>`, :ref:`adv.dif.2D <dg-advection_diffusion_2D>`, :ref:`osc <quantum-oscillator>`
   * - dw_lin_convect
   ...
   * - dw_lin_elastic
     ...
     - :ref:`lin.ela.opt <homogenization-linear_elasticity_opt>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`ela.shi.per <linear_elasticity-elastic_shifted_periodic>`, :ref:`pie.ela.mac <multi_physics-piezo_elasticity_macro>`, :ref:`mat.non <linear_elasticity-material_nonlinearity>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`its.2 <linear_elasticity-its2D_2>`, :ref:`lin.ela.dam <linear_elasticity-linear_elastic_damping>`, :ref:`pre.fib <linear_elasticity-prestress_fibres>`, :ref:`sei.loa <linear_elasticity-seismic_load>`, :ref:`ela <linear_elasticity-elastodynamic>`, :ref:`its.1 <linear_elasticity-its2D_1>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`bio <multi_physics-biot>`, :ref:`lin.vis <linear_elasticity-linear_viscoelastic>`, :ref:`lin.ela.mM <homogenization-linear_elastic_mM>`, :ref:`its.4 <linear_elasticity-its2D_4>`, :ref:`the.ela <multi_physics-thermo_elasticity>`, :ref:`mod.ana.dec <linear_elasticity-modal_analysis_declarative>`, :ref:`ela.con.pla <linear_elasticity-elastic_contact_planes>`, :ref:`two.bod.con <linear_elasticity-two_bodies_contact>`, :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`lin.ela <linear_elasticity-linear_elastic>`, :ref:`its.3 <linear_elasticity-its2D_3>`, :ref:`lin.ela.iga <linear_elasticity-linear_elastic_iga>`, :ref:`nod.lcb <linear_elasticity-nodal_lcbcs>`, :ref:`lin.ela.tra <linear_elasticity-linear_elastic_tractions>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`pie.ela <multi_physics-piezo_elastodynamic>`, :ref:`ela.con.sph <linear_elasticity-elastic_contact_sphere>`
   * - dw_lin_elastic_iso
   ...
   * - dw_point_load
     ...
     - .. math::
           ...
           \mbox{ in a region }
     - :ref:`its.4 <linear_elasticity-its2D_4>`, :ref:`its.2 <linear_elasticity-its2D_2>`, :ref:`its.1 <linear_elasticity-its2D_1>`, :ref:`its.3 <linear_elasticity-its2D_3>`, :ref:`she.can <linear_elasticity-shell10x_cantilever>`
   * - dw_point_lspring
   ...
   * - dw_stokes
     ...
     - .. math::
           ...
           \cdot \ul{u}
     - :ref:`nav.sto.iga <navier_stokes-navier_stokes2d_iga>`, :ref:`sta.nav.sto <navier_stokes-stabilized_navier_stokes>`, :ref:`nav.sto <navier_stokes-navier_stokes2d>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`nav.sto <navier_stokes-navier_stokes>`, :ref:`sto <navier_stokes-stokes>`
   * - dw_stokes_wave
   ...
   * - dw_surface_ltr
     ...
     - :ref:`lin.ela.opt <homogenization-linear_elasticity_opt>`, :ref:`nod.lcb <linear_elasticity-nodal_lcbcs>`, :ref:`lin.ela.tra <linear_elasticity-linear_elastic_tractions>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`ela.shi.per <linear_elasticity-elastic_shifted_periodic>`, :ref:`lin.vis <linear_elasticity-linear_viscoelastic>`
   * - ev_surface_moment
   ...
   * - dw_volume_lvf
     ...
     - .. math::
           ...
           \int_{\Omega} f q
     - :ref:`poi.par.stu <diffusion-poisson_parametric_study>`, :ref:`bur.2D <dg-burgers_2D>`, :ref:`poi.iga <diffusion-poisson_iga>`, :ref:`adv.dif.2D <dg-advection_diffusion_2D>`
   * - dw_volume_nvf
...
.. list-table:: Large deformation terms
   ...
   * - dw_tl_he_neohook
     ...
     - .. math::
            \int_{\Omega} S_{ij}(\ul{u}) \delta E_{ij}(\ul{u};\ul{v})
     - :ref:`per.tl <large_deformation-perfusion_tl>`, :ref:`hyp <large_deformation-hyperelastic>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`bal <large_deformation-balloon>`, :ref:`act.fib <large_deformation-active_fibres>`
   * - dw_tl_he_ogden
