...
/* harmony import */ var _DownloadsContext__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./DownloadsContext */ "./lib/components/DownloadsContext.js");
/* harmony import */ var _ExternalBucketSearchComponent__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./ExternalBucketSearchComponent */ "./lib/components/ExternalBucketSearchComponent.js");
/* harmony import */ var _DownloadPathSetterComponent__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./DownloadPathSetterComponent */ "./lib/components/DownloadPathSetterComponent.js");
...
const FileBrowserComponent = ({ getRootFileStructure, instanceId, selectedOpenDataSource }) => {
    ...
    const { downloadObject } = (0,react__WEBPACK_IMPORTED_MODULE_3__.useContext)(_DownloadsContext__WEBPACK_IMPORTED_MODULE_7__.DownloadContext);
    ...
    }, [setKeyPrefix, folderPrefix, folderChain, isRoot, selectedOption, selectedOpenDataSource, instanceId, customAddBucket.id]);
    let customFileActions;
    if (instanceId === 'favorites')
        customFileActions = [customAddBucket, customDownloadFiles, customRemoveFromFavorite];
    else if (instanceId === 'private')
        customFileActions = [customDownloadFiles, customAddToFavorites];
    else
        customFileActions = [customDownloadFiles, customAddToFavorites];
    ...
    return (react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", { style: { height: '87vh' } },
        ...
        showAddExternalBucketModal &&
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_ExternalBucketSearchComponent__WEBPACK_IMPORTED_MODULE_8__.ExternalBucketSearchComponent, { show: showAddExternalBucketModal, handleClose: handCloseAddExternalBucketModal }),
        showDownloadPathSetterModal &&
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_DownloadPathSetterComponent__WEBPACK_IMPORTED_MODULE_9__.DownloadPathSetterComponent, { show: showDownloadPathSetterModal, handleClose: handCloseDownloadPathSetterModal, setDownloadPath: setDownloadPath })));
};
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'dropdown' },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap_Dropdown__WEBPACK_IMPORTED_MODULE_2__["default"], null,
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap_Dropdown__WEBPACK_IMPORTED_MODULE_2__["default"].Menu, null, openDataSources.map((e, index) => {
                return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap_Dropdown__WEBPACK_IMPORTED_MODULE_2__["default"].Item, { value: e + "-" + index, key: e + "-" + index, onClick: () => {
                        setODSource(e);
                        setSelectedSource(e);
                    }, disabled: e != 'AWS' }, e));
            })))));
...
/* harmony import */ var _FileBrowserComponent__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./FileBrowserComponent */ "./lib/components/FileBrowserComponent.js");
/* harmony import */ var _OpenDataDropdownComponent__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./OpenDataDropdownComponent */ "./lib/components/OpenDataDropdownComponent.js");
/* harmony import */ var _handler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../handler */ "./lib/handler.js");
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: { width: "100%", minWidth: "400px" } },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_FavoriteContext__WEBPACK_IMPORTED_MODULE_2__["default"], null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_DownloadsContext__WEBPACK_IMPORTED_MODULE_3__["default"], null,
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap_Tabs__WEBPACK_IMPORTED_MODULE_4__["default"], { defaultActiveKey: 'nasa', id: 'buckets-tabs', activeKey: key, onSelect: (k) => setKey(k), justify: true },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap_Tab__WEBPACK_IMPORTED_MODULE_5__["default"], { eventKey: 'private', title: 'Private' },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_FileBrowserComponent__WEBPACK_IMPORTED_MODULE_6__["default"], { getRootFileStructure: getRootFileStructure, instanceId: 'private' })),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap_Tab__WEBPACK_IMPORTED_MODULE_5__["default"], { eventKey: 'public', title: 'Public' },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap_Stack__WEBPACK_IMPORTED_MODULE_7__["default"], { gap: 2, className: "pt-2" },
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_OpenDataDropdownComponent__WEBPACK_IMPORTED_MODULE_8__["default"], { setODSource: setSelectedOpenDataSource }),
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_FileBrowserComponent__WEBPACK_IMPORTED_MODULE_6__["default"], { getRootFileStructure: getRootFileStructure, instanceId: 'public', selectedOpenDataSource: selectedOpenDataSource }))),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap_Tab__WEBPACK_IMPORTED_MODULE_5__["default"], { eventKey: 'favorites', title: 'Favorites' },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_FileBrowserComponent__WEBPACK_IMPORTED_MODULE_6__["default"], { getRootFileStructure: getRootFileStructure, instanceId: 'favorites' })))))));
};
...
const telescopeIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.LabIcon({ name: 'telescope', svgstr: _style_Telescope_svg__WEBPACK_IMPORTED_MODULE_1__["default"] });
const telescopeDownloadsIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.LabIcon({ name: 'telescopeDownloads', svgstr: _style_BXplorer_Downloads_svg__WEBPACK_IMPORTED_MODULE_2__["default"] });
...
//# sourceMappingURL=lib_index_js.de51ab72d67d9c2b7817.js.map