...
class HANAScheduler(object):
    ...
    def set_schedule(self, job_name, cron=None, procedure_name=None, job_start_time=None, job_end_time=None, status='active', proceudure_params=None, force=False):
        r"""
        ...
        proceudure_params : dict, optional
            Specifies the parameter name and value in the scheduled procedure. E.g., proceudure_params={"THREAD_RATIO": 1}
        force : bool, optional
        ...
        if proceudure_params:
            p_params_str = ' PARAMETERS '
            for kkey, vval in proceudure_params.items():
