...
setup(
    name='mathkit',
    version='0.1.1.1.1',
    description='MathKit - A Python library for mathematical calculations.',
    long_description='''
===========================
MathKit
===========================
...
For more information, please visit the `GitHub repository <https://github.com/theunkownhacker/mathkit>`_.
''',
