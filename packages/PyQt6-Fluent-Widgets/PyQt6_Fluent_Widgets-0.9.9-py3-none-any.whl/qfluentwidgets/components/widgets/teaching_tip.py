...
from PyQt6.QtCore import Qt, QPoint, QObject, QPointF, QRectF, QSize, QTimer, QPropertyAnimation, QEvent, QMargins
from PyQt6.QtGui import QPainter, QColor, QPainterPath, QIcon, QCursor, QPolygonF, QPixmap, QImage, QBrush
from PyQt6.QtWidgets import QWidget, QFrame, QHBoxLayout, QVBoxLayout, QApplication, QLabel, QGraphicsDropShadowEffect
