...
def get_data_path():
    ...
    f2 = pkg_resources.resource_filename('kanonym4text', 'data/5000_most_common_words_by_order.txt')
    d1 = pkg_resources.resource_filename('kanonym4text', 'data/')
    d2 = pkg_resources.resource_filename('kanonym4text', 'utils/')
    print('f2', f2)
    print('d1', d1)
    print('d2', d2)
    return d2, f2
