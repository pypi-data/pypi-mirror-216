...
class DICRigid(IDIMethod):
    """
    Translation identification based on the Lucas-Kanade method using a rigid geometric
    transformation shape function (2D translation + rotation), least-squares
    ...
    def configure(
        ...
        using iterative least squares optimization of rigid transformation
        parameters (translation + rotation) to determine image ROI motion.
