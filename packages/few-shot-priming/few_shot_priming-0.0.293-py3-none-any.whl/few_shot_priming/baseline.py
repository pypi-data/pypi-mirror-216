...
def baseline(config, experiment, offline=True, validate=True, majority=False):
    ...
    pro_f1 = f1_score(labels, predictions, average=None, pos_label=1)
    con_f1 = f1_score(labels, predictions, average=None, pos_label=0)
    if experiment == "vast":
        neutral_f1 = f1_score(labels, predictions, average=None, pos_label=2)
    else:
        neutral_f1 = None
