...
class REFINED:
    ...
    default_hc_iterations = 100 #Number of iterations is basically how many times the hill climbing goes over the entire features and check each feature exchange cost
    ...
    def __saveSupervised(self,classValue,i,folder,matrix_a):
        ...
        subfolder = str(classValue).zfill(2)  # subfolder for grouping the results of each class
