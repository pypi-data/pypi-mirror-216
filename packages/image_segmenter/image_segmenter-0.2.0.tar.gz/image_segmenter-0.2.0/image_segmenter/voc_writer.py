...
class BBoxFmt():
    ...
    Values
    ------
    XYXY: int 0 the bounding box is specified by the top left and bottom right corners
    XYWH: int 1 the bounding box is specified by the top left corner and the width and height
    XXYY: int 2 the bounding box is specified by the top right and bottom left corners
    YYXX: int 3 the bounding box is specified by the bottom left and top right corners
    YXYX: int 4 the bounding box is specified by the bottom right and top left corners
    '''
    XYXY = 0
    XYWH = 1
    XXYY = 2
...
class VOCWriter():
    ...
    def __enter__(self):
        '''
        Enter the context of the VOCWriter.
        Enables the use of the 'with' statement.
        
        Returns
        -------
        self: VOCWriter the VOCWriter object
        '''
    ...
    def __exit__(self, type, value, traceback) -> None:
        '''
        Exit the context of the VOCWriter.
        Enables the use of the 'with' statement.
        '''
    ...
    def annotate(self, class_name: str, bbox: tuple, difficult: bool = False, truncated: bool = False, bbox_fmt: BBoxFmt = BBoxFmt.XYWH) -> None:
        ...
        '''
        # get the bounding box coordinates depending on the format
