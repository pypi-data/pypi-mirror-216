...
def scaleSvg(svg:str, scale:float=None) -> str:                                  # scaleSvg
    ...
    return svg                                                                   # scaleSvg
try:                                                                             # scaleSvg
    from scipy import stats                                                      # scaleSvg
    __all__.append("pValue")                                                     # scaleSvg
    def pValue(zScore):                                                          # scaleSvg
        """2-sided p value of a particular z score. Requires :mod:`scipy`."""    # scaleSvg
        return stats.norm.sf(abs(zScore))*2                                      # scaleSvg
except: pass                                                                     # scaleSvg
