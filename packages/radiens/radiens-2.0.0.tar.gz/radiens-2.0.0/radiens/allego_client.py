...
class AllegoClient:
    ...
    def get_analog_out_settings(self):
        """
    ...
    def set_sampling_freq(self, fs: float):
        """
    ...
    def set_analog_out_high_pass(self, cutoff_freq: float, enable=True):
        """
    ...
    def set_recording_config(self, datasource_path: str, datasource_name: str, datasource_idx: int, is_time_stamp=True):
        """
