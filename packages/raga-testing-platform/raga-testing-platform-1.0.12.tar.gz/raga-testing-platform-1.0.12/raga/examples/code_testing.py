...
# data_frame_extractor(pd_ds).to_csv("improved-image-editing.csv", index=False)
...
schema.add("Crowd", AttributeSchemaElement(), pd_ds)
schema.add("UnnaturalPose", AttributeSchemaElement(), pd_ds)
...
# test_session = TestSession("testingProject", "test_iteration")

# # # Create an instance of the Dataset class
# test_ds = Dataset(test_session, "self_serve-Image-Editing")
...
# testName = StringElement("testABNewTest1")
...
# testName = StringElement("testABNewTest2")
# modelA = StringElement("modelA")
# modelB = StringElement("modelB")
# gt = StringElement("")
