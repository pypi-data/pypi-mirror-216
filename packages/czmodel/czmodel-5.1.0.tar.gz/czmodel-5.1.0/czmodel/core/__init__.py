...
"""Core Package, no dependency on Tensorflow or Pytorch."""
from czmodel.core.model_spec import ModelSpec
from czmodel.core.legacy_model_spec import ModelSpec as LegacyModelSpec
