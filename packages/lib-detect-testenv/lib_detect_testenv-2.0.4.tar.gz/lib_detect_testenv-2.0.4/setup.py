...
long_description = "detects if pytest or doctest or pyrunner on pycharm is running"
...
setup_kwargs["entry_points"] = {"console_scripts": ["lib_detect_testenv = lib_detect_testenv.lib_detect_testenv_cli:cli_main"]}
