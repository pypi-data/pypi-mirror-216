...
python2R <- function(pyobj) {
  ...
  try(units::install_unit('ac', '4046.86 m**2'), TRUE)
  try(units::install_unit('a', '100.0 m**2'), TRUE)
  try(units::install_unit('j', 'J'), TRUE)
  try(units::install_unit('ha', '10000.0 m**2'), TRUE)
  # try(units::install_conversion_constant('ac', 'm**2', 4046.86), TRUE)
  # try(units::install_conversion_constant('a', 'm**2', 100.0), TRUE)
  # try(units::install_conversion_constant('j', 'J', 1.0), TRUE)
  # try(units::install_conversion_constant('ha', 'm**2', 10000.0), TRUE)
