...
class InfoExtractor:
    ...
    def FormatSort(cls):
        ...
        deprecation_warning(
            'yt_dlp_cp.InfoExtractor.FormatSort is deprecated and may be removed in the future. '
            'Use yt_dlp_cp.utils.FormatSorter instead')
        return FormatSort

    def _sort_formats(self, formats, field_preference=[]):
        if not field_preference:
            self._downloader.deprecation_warning(
                'yt_dlp_cp.InfoExtractor._sort_formats is deprecated and is no longer required')
            return
        self._downloader.deprecation_warning(
            'yt_dlp_cp.InfoExtractor._sort_formats is deprecated and no longer works as expected. '
    ...
    def _live_title(self, name):
        self._downloader.deprecation_warning('yt_dlp_cp.InfoExtractor._live_title is deprecated and does not work as expected')
        return name
