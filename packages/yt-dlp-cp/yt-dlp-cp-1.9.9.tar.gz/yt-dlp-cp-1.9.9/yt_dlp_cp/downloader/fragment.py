...
class FragmentFD(FileDownloader):
    ...
    def report_retry_fragment(self, err, frag_index, count, retries):
        self.deprecation_warning('yt_dlp_cp.downloader.FragmentFD.report_retry_fragment is deprecated. '
                                 'Use yt_dlp_cp.downloader.FileDownloader.report_retry instead')
