    ...
    def __init__(self, downloader, path='', args=None, ignoreerror=False, cut=False, force=False, _from_cli=False):
        ...
        if not _from_cli:
            self.deprecation_warning(
                'yt_dlp_cp.postprocessor.SponSkrubPP support is deprecated and may be removed in a future version. '
                'Use yt_dlp_cp.postprocessor.SponsorBlock and yt_dlp_cp.postprocessor.ModifyChaptersPP instead')
