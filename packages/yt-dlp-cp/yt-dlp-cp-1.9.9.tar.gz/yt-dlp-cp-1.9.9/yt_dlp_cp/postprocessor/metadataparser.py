...
class MetadataFromTitlePP(MetadataParserPP):
    def __init__(self, downloader, titleformat):
        ...
        self.deprecation_warning(
            'yt_dlp_cp.postprocessor.MetadataFromTitlePP is deprecated '
            'and may be removed in a future version. Use yt_dlp_cp.postprocessor.MetadataFromFieldPP instead')
