...
import yt_dlp_cp.YoutubeDL  # isort: split
from yt_dlp_cp.extractor import get_info_extractor
from yt_dlp_cp.utils import (
    DownloadError,
    ExtractorError,
...
class YoutubeDL(yt_dlp_cp.YoutubeDL):
...
def generator(test_case, tname):
    def test_template(self):
        ...
        ie = yt_dlp_cp.extractor.get_info_extractor(test_case['name'])()
