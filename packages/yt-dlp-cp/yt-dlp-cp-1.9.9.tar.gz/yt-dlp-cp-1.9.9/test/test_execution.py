...
from yt_dlp_cp.utils import Popen

rootDir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
LAZY_EXTRACTORS = 'yt_dlp_cp/extractor/lazy_extractors.py'


class TestExecution(unittest.TestCase):
    def run_yt_dlp(self, exe=(sys.executable, 'yt_dlp_cp/__main__.py'), opts=('--version', )):
    ...
    def test_import(self):
        self.run_yt_dlp(exe=(sys.executable, '-c', 'import yt_dlp_cp'))

    def test_module_exec(self):
        self.run_yt_dlp(exe=(sys.executable, '-m', 'yt_dlp_cp'))
