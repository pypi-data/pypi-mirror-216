...
import yt_dlp_cp.extractor
from yt_dlp_cp import YoutubeDL
from yt_dlp_cp.compat import compat_os_name
from yt_dlp_cp.utils import preferredencoding, write_string
...
def gettestcases(include_onlymatching=False):
    for ie in yt_dlp_cp.extractor.gen_extractors():
