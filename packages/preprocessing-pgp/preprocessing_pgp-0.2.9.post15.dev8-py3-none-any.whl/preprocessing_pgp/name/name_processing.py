...
class NameProcessor:
    ...
    def predict_non_accent(self, name: str):
        ...
        predicted_name = self.model.predict(de_name)
    ...
    def fill_accent(
        ...
        if not bad_accent_name_df.empty:
            ...
            # start_time = time()
            predicted_name["predict"] = predicted_name[f"clean_{name_col}"].progress_apply(
        ...
        # * Final postprocess
        final_name["final"] = replace_trash_string(final_name, replace_col="final")
