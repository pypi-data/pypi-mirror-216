...
class MobiPhoneValidator(PhoneValidator):
    ...
    def is_new_phone(self, phone: str) -> bool:
        ...
        return self._is_new_phone_length(phone) and self._is_new_sub_phone(phone)
    ...
    def is_old_phone(self, phone: str) -> bool:
        ...
        return self._is_old_phone_length(phone) and self._is_old_sub_phone(phone)
...
class LandlinePhoneValidator(PhoneValidator):
    ...
    def _is_new_sub_phone(self, phone: str) -> bool:
        return phone[:3] in SUB_TELEPHONE_11NUM or phone[:4] in SUB_TELEPHONE_11NUM
