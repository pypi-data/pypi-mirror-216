...
class AbstractDataStorage(ABC):
    ...
    def create_udf_table(
        self, name: str, custom_columns: Sequence["sa.Column"] = ()
    ) -> "sa.Table":
    ...
    def cleanup_temp_tables(self, names: Iterable[str]) -> None:  # noqa: B027
        ...
        This should be implemented for backends where temporary tables
        are not suitable and we need to explicitly clean them up. If
        temporary tables are used, this should be a no-op.
        """
