...
from invision_client import rest
from invision_client.configuration import Configuration
from invision_client.exceptions import ApiTypeError, ApiValueError, ApiException
from invision_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ForumsApi()
        api_instance.forums_forums_get  # this is an instance of the class Endpoint
        api_instance.forums_forums_get()  # this invokes api_instance.forums_forums_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.forums_forums_get.callable or self.callable in this class
