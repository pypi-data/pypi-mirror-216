...
class CleanDomainGenerator:
    ...
    def generate(self):
        """Generate domain class {{Project}}.java"""
        target_filename = self.capitalize + ".java"
        processor = TemplateProcessor("../resources/tpl/clean_domain.tpl", os.path.join(self.project_dir, "application/core/domains"))
        data = {
