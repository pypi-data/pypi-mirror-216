...
class CleanConfigGenerator:
    ...
    def generate(self):
        """Generate a java class with name Create{{Project}}UseCaseConfig.java"""
        target_filename = "Create" + self.capitalize + "UseCaseConfig.java"
        processor = TemplateProcessor("../resources/tpl/clean_config.tpl", os.path.join(self.project_dir, "config/usecases"))
        data = {
