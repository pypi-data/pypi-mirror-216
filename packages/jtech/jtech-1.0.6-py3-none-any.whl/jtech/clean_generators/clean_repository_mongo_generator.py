...
class CleanRepositoryMongoGenerator:
    """
    ...
    def generate(self):
        """Generate an interface {{Project}}Repository """
        target_filename = self.cap_name + "Repository.java"
        processor = TemplateProcessor("../resources/tpl/clean_repository_mongo.tpl",
