...
class ModelAssociation extends AssociationLZ {
    ...
    _performRequest(options) {
        return __awaiter(this, void 0, void 0, function* () {
            // TODO: find a way to fetch right view.
            /**
...
class LocusZoomView extends base_1.DOMWidgetView {
    ...
    render() {
        ...
        dataSources
            ...
            .add("phewas", ["PheWASLZ", {
                url: "https://portaldev.sph.umich.edu/" + "api/v1/statistic/phewas/", build: [build]
            }]);
        const initialState = this.positionState;
        console.log(initialState);
        const layout = locuszoom_1.default.Layouts.get("plot", "standard_association", { state: initialState });
...
//# sourceMappingURL=lib_widget_js.de2f37af2c0d8baa33d7.js.map