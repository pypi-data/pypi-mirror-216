...
if __name__ == "__main__":
    ...
    # )
    path_to_models = Path.joinpath(
        Path(__file__).parent.parent.parent, r"C:\Users\jlidholm\cernbox\Git-projects\steam_models\magnets")
    ...
    for model_name in model_names:
        ...
        if os.path.isfile(yaml_file):
            ...
            model_data.Quench_Protection.Quench_Heaters.turns_sides =[str('o') for _ in range(len(model_data.Quench_Protection.Quench_Heaters.iQH_toHalfTurn_To))]
