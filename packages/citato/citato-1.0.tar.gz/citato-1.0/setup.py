...
setup(
    name="citato",
    packages=["citato", "citato.lib", "citato.containers"],
    version="1.0",
    license="MIT",
    ...
    url="https://github.com/ekosijabat/citato",
    download_url="https://github.com/ekosijabat/citato/archive/refs/tags/v1.0.tar.gz",
