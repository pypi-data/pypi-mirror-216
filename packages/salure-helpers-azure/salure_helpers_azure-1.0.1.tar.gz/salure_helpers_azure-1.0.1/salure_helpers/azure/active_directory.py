...
class ActiveDirectory(SalureConnect):
    ...
    def __get_headers(self, label):
        credentials = self.get_system_credential(system='azure-active-directory-customer', label=label)
    ...
    def get_group_members(self, group_id: str = '') -> pd.DataFrame:
        """
        Get all users from a group in Azure Active Directory
    ...
    def delete_group(self, group_id):
        """
        Delete a group in Azure Active Directory
    ...
    def get_users(self, extra_fields: list = [], custom_attributes: bool = False) -> pd.DataFrame:
        """
    ...
    def update_user(self, user_id, fields_to_update: dict = {}, custom_attributes: dict = {}, update_password: bool = False):
        """
        Update a user in Azure Active Directory
    ...
    def delete_user(self, user_id, delete=False):
        """
        Delete (soft or hard) a user from Azure Active Directory
        :param user_id: The Azure AD ID of the user
