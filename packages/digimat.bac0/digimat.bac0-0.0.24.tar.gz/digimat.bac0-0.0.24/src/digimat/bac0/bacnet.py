...
class BACPoint(object):
    ...
    def digUnit(self):
        ...
        elif unit==BAC0.bacpypes.basetypes.EngineeringUnits.percent:
            return units.getByName('%')
        elif unit==BAC0.bacpypes.basetypes.EngineeringUnits.pascals:
...
class BAC(object):
    def __init__(self, network=None, router=None, discover=False, logServer='localhost', logLevel=logging.DEBUG):
