...
class FormationInput(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, source_well_id, source_wellbore_id, name, pressure_formation_initial_datum, temperature_formation_datum, depth, rsi, fluid_gravity_api, fluid_gravity_gas, fluid_salinity_water, *args, **kwargs):  # noqa: E501
