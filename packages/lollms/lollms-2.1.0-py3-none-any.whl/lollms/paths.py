...
class LollmsPaths:
    ...
    def resetPaths(self, force_local=None):
        global_paths_cfg_path = Path("./lollms_global_paths_cfg_path.yaml")
        ...
        print(f"You can change this at any tome using the lollms-settings script or by simply change the content of the lollms_global_paths_cfg_path.yaml file.")
        found = False
        while not found:
            ...
            if force_local:
                ...
                global_paths_cfg_path = Path.home()/"lollms_global_paths_cfg_path.yaml"
