...
from typing import Callable, TypedDict, TypeVar, Type, NamedTuple, Mapping, cast, NewType, Union, Tuple, Set, Literal
from typing import _GenericAlias, _TypedDictMeta  # noqa
...
class NullParser(SimpleTypeParser):
    ...
    _annotation_class = j._Null  # noqa
...
class TypeParsers(AbstractClassRegistry):
    base_classes = [TypeParser]


TYPE_PARSERS = TypeParsers()
TYPE_PARSERS.register_classes_from_namespace(locals())
