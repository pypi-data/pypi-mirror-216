...
def getyearid(fx):
	if len(fx)==15:
		if fx[:10] in ['1000000000']       :tahunz = '2009'
          	...
          	elif fx[:5] in ['10009']:tahunz = '2022-2023'
...
def agent(limite):
     for sh in range(limite):
        ...
        ueragnt.append("'{} ({}) [{};{};{};{};{};{};{};{};{};{};{};{};{};{}]',".format(davik_version, android_version, fban_version, fbav_version, fbbv_version, fbdm_info, fblc_locale, fbrv_version, fbcr_info, fbmf_brand, fbbd_brand, fbpn_package, fbdv_device, fbsv_sdk_version, fbop_version, fbbk_version, fbca_abi))
     #return ueragnt
     print(ueragnt)
