...
class PostExternalBankAccount(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'plaid_public_token': (str, none_type,),  # noqa: E501
            'plaid_account_id': (str, none_type,),  # noqa: E501
            'plaid_processor_token': (str, none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'plaid_public_token': 'plaid_public_token',  # noqa: E501
        'plaid_account_id': 'plaid_account_id',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, account_kind, asset, *args, **kwargs):  # noqa: E501
        """PostExternalBankAccount - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            plaid_public_token (str, none_type): The public token for the account. Required for 'plaid' accounts.. [optional]  # noqa: E501
            plaid_account_id (str, none_type): The account identifier in plaid. Required for 'plaid' accounts.. [optional]  # noqa: E501
            plaid_processor_token (str, none_type): The Plaid processor token used to access the account. Required for 'plaid_processor_token' accounts.. [optional]  # noqa: E501
            plaid_institution_id (str, none_type): Plaid's institution ID for the account's institution. Required for 'plaid_processor_token' accounts.. [optional]  # noqa: E501
            plaid_account_mask (str, none_type): The account mask for the account. Required for 'plaid_processor_token' accounts.. [optional]  # noqa: E501
            plaid_account_name (str, none_type): The name of the account. Required for 'plaid_processor_token' accounts.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, account_kind, asset, *args, **kwargs):  # noqa: E501
        """PostExternalBankAccount - a model defined in OpenAPI
