...
class PostQuote(ModelNormal):
    ...
    def _from_openapi_data(cls, side, *args, **kwargs):  # noqa: E501
        """PostQuote - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            asset (str): The asset code the quote was requested for. Populated for funding, book transfer and crypto transfer quotes.. [optional]  # noqa: E501
            symbol (str): Symbol the quote is being requested for. Format is \"asset-counter_asset\" in uppercase. See the Symbols API for a complete list of cryptocurrencies supported. Populated for trade quotes.. [optional]  # noqa: E501
