...
class SymbolsBankApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_symbols_endpoint = _Endpoint(
            settings={
    ...
    def list_symbols(
        ...
        **kwargs
        ...
        Retrieves a listing of symbols.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_symbols(async_req=True)
        >>> result = thread.get()
        ...
        return self.list_symbols_endpoint.call_with_http_info(**kwargs)
