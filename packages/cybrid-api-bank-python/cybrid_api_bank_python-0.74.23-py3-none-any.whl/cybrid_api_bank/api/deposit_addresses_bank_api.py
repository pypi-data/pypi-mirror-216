...
class DepositAddressesBankApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_deposit_address_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/deposit_addresses',
                'operation_id': 'create_deposit_address',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'post_deposit_address',
                ],
                'required': [
                    'post_deposit_address',
                ],
        ...
        self.get_deposit_address_endpoint = _Endpoint(
            settings={
                'response_type': (DepositAddress,),
                'auth': [
                    'BearerAuth',
                ...
                'endpoint_path': '/api/deposit_addresses/{deposit_address_guid}',
                'operation_id': 'get_deposit_address',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_deposit_addresses_endpoint = _Endpoint(
            settings={
                'response_type': (DepositAddressList,),
                'auth': [
                    'BearerAuth',
                    'oauth2'
                ],
    ...
    def create_deposit_address(
        ...
        **kwargs
        ...
        """Create Deposit Address  # noqa: E501

        Creates a deposit address.  ## State  | State | Description | |-------|-------------| | storing | The Platform is storing the deposit address details in our private store | | created | The Platform has created the deposit address |    Required scope: **deposit_addresses:execute**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_deposit_address(post_deposit_address, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['post_deposit_address'] = \
            post_deposit_address
        return self.create_deposit_address_endpoint.call_with_http_info(**kwargs)
    ...
    def get_deposit_address(
        ...
        **kwargs
        ...
        Retrieves a deposit address.  Required scope: **deposit_addresses:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_deposit_address(deposit_address_guid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        kwargs['deposit_address_guid'] = \
            deposit_address_guid
        return self.get_deposit_address_endpoint.call_with_http_info(**kwargs)
    ...
    def list_deposit_addresses(
        ...
        **kwargs
        ...
        Retrieves a list of deposit addresses.  Required scope: **deposit_addresses:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_deposit_addresses(async_req=True)
        >>> result = thread.get()
