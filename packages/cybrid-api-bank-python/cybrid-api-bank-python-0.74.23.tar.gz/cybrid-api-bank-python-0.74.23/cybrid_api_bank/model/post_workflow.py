...
class PostWorkflow(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostWorkflow - a model defined in OpenAPI

        Args:

        Keyword Args:
            type (str): The workflow type.. defaults to "plaid", must be one of ["plaid", ]  # noqa: E501
            ...
            kind (str): The Plaid workflow kind.. [optional]  # noqa: E501
            customer_guid (str): The customer identifier associated with the workflow.. [optional]  # noqa: E501
            external_bank_account_guid (str): The external bank account identifier associated with the workflow.. [optional]  # noqa: E501
            language (str): The language to initialize Plaid link.. [optional]  # noqa: E501
            link_customization_name (str): The customization name for Plaid link.. [optional]  # noqa: E501
            redirect_uri (str, none_type): The redirect URI for Plaid link.. [optional]  # noqa: E501
            android_package_name (str, none_type): The Android package name for Plaid link.. [optional]  # noqa: E501
        """

        type = kwargs.get('type', "plaid")
