...
def lazy_import():
    ...
    globals()['ExternalWallet'] = ExternalWallet


class ExternalWalletList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([ExternalWallet],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """ExternalWalletList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([ExternalWallet]): Array of external wallet entities
