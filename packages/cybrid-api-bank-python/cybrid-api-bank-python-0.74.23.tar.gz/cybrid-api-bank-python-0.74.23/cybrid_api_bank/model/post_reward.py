...
class PostReward(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, customer_guid, symbol, *args, **kwargs):  # noqa: E501
        """PostReward - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, customer_guid, symbol, *args, **kwargs):  # noqa: E501
        """PostReward - a model defined in OpenAPI
