...
class PostExternalWallet(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, asset, address, *args, **kwargs):  # noqa: E501
        """PostExternalWallet - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, asset, address, *args, **kwargs):  # noqa: E501
        """PostExternalWallet - a model defined in OpenAPI
