...
class IdentityVerificationList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([IdentityVerification],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """IdentityVerificationList - a model defined in OpenAPI
