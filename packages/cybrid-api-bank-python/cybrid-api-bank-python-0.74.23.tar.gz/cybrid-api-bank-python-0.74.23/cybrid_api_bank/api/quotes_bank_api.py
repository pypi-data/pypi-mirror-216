...
class QuotesBankApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_quote_endpoint = _Endpoint(
            settings={
                'response_type': (Quote,),
                'auth': [
                    'BearerAuth',
        ...
        self.get_quote_endpoint = _Endpoint(
            settings={
                'response_type': (Quote,),
                'auth': [
                    'BearerAuth',
                ...
                'endpoint_path': '/api/quotes/{quote_guid}',
        ...
        self.list_quotes_endpoint = _Endpoint(
            settings={
                'response_type': (QuoteList,),
                'auth': [
                    'BearerAuth',
                    'oauth2'
                ],
    ...
    def create_quote(
        ...
        **kwargs
        ...
        Creates a quote.  Required scope: **quotes:execute**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_quote(post_quote, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['post_quote'] = \
            post_quote
        return self.create_quote_endpoint.call_with_http_info(**kwargs)
    ...
    def get_quote(
        ...
        **kwargs
        ...
        Retrieves a quote.  Required scope: **quotes:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_quote(quote_guid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['quote_guid'] = \
            quote_guid
        return self.get_quote_endpoint.call_with_http_info(**kwargs)

    def list_quotes(
        self,
        **kwargs
    ):
        """Get quotes list  # noqa: E501

        Retrieves a listing of quotes for all customers of a bank.  Required scope: **quotes:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_quotes(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.list_quotes_endpoint.call_with_http_info(**kwargs)
