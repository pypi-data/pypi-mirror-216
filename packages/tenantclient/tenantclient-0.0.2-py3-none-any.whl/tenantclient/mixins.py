...
from .query import wrap_get_compiler, wrap_update_batch, wrap_delete, wrap_insert_batch
...
class TenantModelMixin(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if not hasattr(InsertQuery.get_compiler, "_sign"):
            InsertQuery.insert_values = wrap_insert_batch(InsertQuery.insert_values)
