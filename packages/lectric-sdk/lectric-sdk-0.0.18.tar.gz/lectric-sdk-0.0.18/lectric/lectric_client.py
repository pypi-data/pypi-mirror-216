...
from .api.exact import (
    ...
    raw_query_exact_raw_query_post,
    options_info_exact_options_info_get,
...
class LectricClient:
    ...
    def put_exact(self, collection_name: str,
        ...
        Args:
            ...
            timestamp (str, optional): Timestamp to associate with entry
        ...
        if uri:
            ...
            return put_entry_by_file_exact_hash_collection_name_file_put.sync_detailed(
                ...
                multipart_data=BodyPutEntryByFileExactHashCollectionNameFilePut(
                    ...
                    ), foreign_key = foreign_key, algo=algo, metadata=metadata, upsert=upsert, timestamp=timestamp
                )
    ...
    def raw_query(self, query: str) -> List[Tuple]:
        """Query directly into the underlying storage for data. Use SQL syntax
        ...
        """
        return raw_query_exact_raw_query_post.sync_detailed(client=self.client, query=query)
    
    @propagate_exception
    def get_options_info(self, collection_name: str):
        return options_info_exact_options_info_get.sync_detailed(client=self.client, name=collection_name)
