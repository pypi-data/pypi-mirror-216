...
setuptools.setup(
    ...
    scripts = ['cloci/README.md', 'cloci/TODO.md', 'cloci/prepUpdate.py', 'cloci/setup.py', 'cloci/lib/output_data.py', 'cloci/lib/evo_conco.py', 'cloci/lib/generate_nulls.py', 'cloci/lib/hgp2hgx.py', 'cloci/lib/hgx2hlgs.py', 'cloci/lib/input_parsing.py', 'cloci/lib/treecalcs.py'],
