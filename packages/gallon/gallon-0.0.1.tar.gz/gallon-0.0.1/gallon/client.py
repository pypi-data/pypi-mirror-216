...
class GallonClient(http.client.HTTPConnection):
    ...
    def _prepare_body(self, request: Request):
        ...
        if request.content_type == "application/x-www-form-urlencoded":
            ...
            return urllib.parse.urlencode(_json)
    ...
    def get(self, url: str, headers: Optional[Dict[str, str]] = None):
        ...
        return self.fetch(Request(method="GET", url=url, body=None, headers=headers))
    ...
    def delete(self, url: str, headers: Optional[Dict[str, str]] = None):
        ...
        return self.fetch(
            Request(method="DELETE", url=url, body=None, headers=headers)
        )
