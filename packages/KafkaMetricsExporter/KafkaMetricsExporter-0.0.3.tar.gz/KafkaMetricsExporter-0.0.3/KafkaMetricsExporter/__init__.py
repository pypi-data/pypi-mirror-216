...
class KafkaMetricExporter(MetricExporter):
    ...
    def export(
        ...
        **kwargs,
        ...
        translated_message = encode_metrics(metrics_data)
        # Serialize ExportMetricsServiceRequest to bytes
        encoded_message = translated_message.SerializeToString()

        # Send the message to Kafka
        self.producer = Producer({'bootstrap.servers': self.endpoint})
        self.producer.produce('metric-topic', value=encoded_message)
        self.producer.flush()
