...
# Form implementation generated from reading ui file '/tmp/build-via-sdist-9fmfj3b4/MTGProxyPrinter-0.24.1/mtg_proxy_printer/resources/ui/central_widget/tabbed_vertical.ui'
#
...
class Ui_central_widget(object):
    ...
    def retranslateUi(self, central_widget):
        ...
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.document_view), _translate("central_widget", "All pages"))
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.add_card_widget), _translate("central_widget", "Add new cards"))
        self.delete_selected_images_button.setText(_translate("central_widget", "Remove selected"))
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.tab), _translate("central_widget", "Current page"))
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.page_renderer), _translate("central_widget", "Preview"))
