...
# Form implementation generated from reading ui file '/tmp/build-via-sdist-9fmfj3b4/MTGProxyPrinter-0.24.1/mtg_proxy_printer/resources/ui/settings_window/settings_window.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pdf_page_count_limit = QtWidgets.QSpinBox(self.tab_page_sizes)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.tab_page_sizes_layout.addWidget(self.pdf_page_count_limit, 1, 1, 1, 1)
        self.pdf_page_count_limit_label = QtWidgets.QLabel(self.tab_page_sizes)
        self.pdf_page_count_limit_label.setObjectName("pdf_page_count_limit_label")
        self.tab_page_sizes_layout.addWidget(self.pdf_page_count_limit_label, 1, 0, 1, 1)
        self.tab_widget.addTab(self.tab_page_sizes, "")
        self.tab_card_data_download = QtWidgets.QWidget()
        self.tab_card_data_download.setObjectName("tab_card_data_download")
        self.tab_card_data_download_layout = QtWidgets.QVBoxLayout(self.tab_card_data_download)
        self.tab_card_data_download_layout.setObjectName("tab_card_data_download_layout")
        self.card_filter_settings_header_label = QtWidgets.QLabel(self.tab_card_data_download)
        ...
        self.card_filter_general_settings = GeneralPrintingFilterWidget(self.tab_card_data_download)
        ...
        self.card_filter_format_settings = FormatPrintingFilterWidget(self.tab_card_data_download)
        ...
        self.tab_card_data_download_layout.addItem(spacerItem3)
        self.tab_widget.addTab(self.tab_card_data_download, "")
        ...
        self.gridLayout_7.addItem(spacerItem4, 9, 0, 1, 2)
