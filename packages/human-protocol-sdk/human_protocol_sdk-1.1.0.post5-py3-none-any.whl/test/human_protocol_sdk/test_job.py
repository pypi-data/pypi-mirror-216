...
class JobTestCase(unittest.TestCase):
    ...
    def test_status_retry(self):
        status_mock = MagicMock(side_effect=Exception)

        with patch("human_protocol_sdk.job.status", status_mock):
            self.assertFalse(self.job.launch(self.rep_oracle_pub_key))
