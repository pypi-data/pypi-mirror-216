...
from specklia import websocket_helpers
...
class Specklia:
    ...
    def user_id(self: Specklia) -> str:
        ...
        Giving this to another user will allow them to e.g. add you to one of their groups.
    ...
    def query(self: Specklia, dataset_id: str, epsg4326_polygon: Polygon,  # noqa: CFQ002
        ...
        additional_filters: List[Dict[str, Union[float, str]]]
            ...
            A list of dicts of the form {'column': str, 'op': str, 'threshold': Union[float, str]} where:
        ...
        ws = simple_websocket.Client(
            ...
            headers={"Authorization": "Bearer " + self.auth_token})
        websocket_helpers.send_object_to_websocket(ws, {
    ...
    def create_dataset(
        ...
        After you have created the dataset, you'll probably want to add data to it using Specklia.ingest()
