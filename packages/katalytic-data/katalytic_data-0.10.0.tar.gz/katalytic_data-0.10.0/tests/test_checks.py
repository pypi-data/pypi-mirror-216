...
from katalytic.data.checks import (
    contains_all_of, contains_any_of, contains_none_of, is_any_of, is_dict_of_sequences, is_generator, is_generator_expression, is_generator_function, is_iterable, is_iterable_or_str, is_iterator, is_none_of, is_number, is_primitive,
