...
from katalytic.data.checks import is_any_of, is_iterable, is_iterator, is_none_of, is_primitive, is_dict_of_sequences_uniform, is_sequence, is_sequence_of_sequences_uniform, is_sequence_of_dicts_uniform

from katalytic.pkg import get_version

if __name__ != '__main__':
    __version__, __version_info__ = get_version('katalytic.data')
...
def map_recursive(f, data, *, condition=is_primitive, on_dict_keys=False):
    ...
    Args:
        ...
        condition (optional): A condition function to determine whether an element should be mapped or not. If None, all elements are mapped. Default is is_primitive, which maps only primitive values (not containers). (default: is_primitive)
        on_dict_keys (optional): Specifies whether to apply the mapping on dictionary keys. If True, the function will also be applied to dictionary keys. Default is False. (default: False)

    Returns:
        The data structure with the mapped elements.

    Raises:
        TypeError: If f is not callable, data is not iterable, condition is not None or callable, or on_dict_keys is not a boolean.
...
def pop_min(data, *, condition=lambda x: x, default=_UNDEFINED):
    ...
    Args:
        ...
        condition (optional): A function to determine the sorting order of elements. The minimum element is determined based on the result of applying this function to each element. Default is identity function. (default: lambda x: x)
        default (optional): A default value to be returned if the collection is empty. If not provided and the collection is empty, a ValueError is raised. (default: _UNDEFINED)
...
def pop_max(data, *, condition=lambda x: x, default=_UNDEFINED):
    ...
    Args:
        ...
        condition (optional): A function to determine the sorting order of elements. The maximum element is determined based on the result of applying this function to each element. Default is identity function. (default: lambda x: x)
        default (optional): A default value to be returned if the collection is empty. If not provided and the collection is empty, a ValueError is raised. (default: _UNDEFINED)
...
def pop_max_by_dict_key(data, *, condition=lambda x: x, default=_UNDEFINED):
    ...
    Args:
        ...
        condition (optional): A function to determine the sorting order of keys. The maximum (key, value) pair is determined based on the result of applying this function to each key. Default is identity function. (default: lambda x: x)
        default (optional): A default value to be returned if the dictionary is empty. If not provided and the dictionary is empty, a ValueError is raised. (default: _UNDEFINED)

    Returns:
        A tuple containing the maximum (key, value) pair and the modified dictionary without the maximum (key, value) pair.
...
def pop_min_by_dict_key(data, *, condition=lambda x: x, default=_UNDEFINED):
    ...
    Args:
        ...
        condition (optional): A function to determine the sorting order of keys. The minimum (key, value) pair is determined based on the result of applying this function to each key. Default is identity function. (default: lambda x: x)
        default (optional): A default value to be returned if the dictionary is empty. If not provided and the dictionary is empty, a ValueError is raised. (default: _UNDEFINED)

    Returns:
        A tuple containing the minimum (key, value) pair and the modified dictionary without the minimum (key, value) pair.
...
def pop_max_by_dict_value(data, *, condition=lambda x: x, default=_UNDEFINED):
    ...
    Args:
        data: The dictionary from which the maximum (key, value) pair is to be removed. Must be a dict.
        condition (optional): A function to determine the sorting order of values. The maximum (key, value) pair is determined based on the result of applying this function to each value. Default is identity function. (default: lambda x: x)
        default (optional): A default value to be returned if the dictionary is empty. If not provided and the dictionary is empty, a ValueError is raised. (default: _UNDEFINED)
...
def pop_min_by_dict_value(data, *, condition=lambda x: x, default=_UNDEFINED):
    ...
    Args:
        data: The dictionary from which the minimum (key, value) pair is to be removed. Must be a dict.
        condition (optional): A function to determine the sorting order of values. The minimum (key, value) pair is determined based on the result of applying this function to each value. Default is identity function. (default: lambda x: x)
        default (optional): A default value to be returned if the dictionary is empty. If not provided and the dictionary is empty, a ValueError is raised. (default: _UNDEFINED)
...
def sort_dict_by_keys(data, *, condition=None, reverse=False):
    ...
    Args:
        ...
        condition (optional): A function to determine the sorting order of keys. If provided, the keys are sorted based on the result of applying this function to each key. If None, the keys are sorted naturally. Default is None. (default: None)
        reverse (optional): Specifies whether to sort in reverse order. If True, the dictionary is sorted in descending order. If False, the dictionary is sorted in ascending order. Default is False. (default: False)
...
def sort_dict_by_keys_recursive(data, *, condition=None, reverse=False):
    ...
    Args:
        ...
        condition (optional): A function to determine the sorting order of keys. If provided, the keys are sorted based on the result of applying this function to each key. If None, the keys are sorted naturally. Default is None. (default: None)
        reverse (optional): Specifies whether to sort in reverse order. If True, the structure is sorted in descending order. If False, the structure is sorted in ascending order. Default is False. (default: False)
    ...
    if isinstance(data, dict):
        return sort_dict_by_keys({k: sort_dict_by_keys_recursive(v, condition=condition, reverse=reverse) if is_iterable(v) else v for k, v in data.items()}, condition=condition, reverse=reverse)
    elif is_iterator(data):
        return (sort_dict_by_keys_recursive(v, condition=condition, reverse=reverse) if is_iterable(v) else v for v in data)
    elif is_iterable(data):
        return type(data)(sort_dict_by_keys_recursive(v, condition=condition, reverse=reverse) if is_iterable(v) else v for v in data)
...
def sort_dict_by_values(data, *, condition=None, reverse=False):
    ...
    Args:
        data: The dictionary to be sorted. Must be a dict.
        condition (optional): A function to determine the sorting order of values. If provided, the values are sorted based on the result of applying this function to each value. If None, the values are sorted naturally. Default is None. (default: None)
        reverse (optional): Specifies whether to sort in reverse order. If True, the dictionary is sorted in descending order. If False, the dictionary is sorted in ascending order. Default is False. (default: False)
...
def sort_dict_by_values_recursive(data, *, condition=None, reverse=False):
    ...
    if isinstance(data, dict):
        return sort_dict_by_values({k: sort_dict_by_values_recursive(v, condition=condition, reverse=reverse) if is_iterable(v) else v for k, v in data.items()}, condition=condition, reverse=reverse)
    elif is_iterator(data):
        return (sort_dict_by_values_recursive(v, condition=condition, reverse=reverse) if is_iterable(v) else v for v in data)
    elif is_iterable(data):
        return type(data)(sort_dict_by_values_recursive(v, condition=condition, reverse=reverse) if is_iterable(v) else v for v in data)


def sort_recursive(data, *, condition=lambda x: x, reverse=False, sort_dicts_by='keys', sort_iters=True, sort_lists=True, sort_sets=True, sort_tuples=True):
    """
    ...
    Args:
        data: The data structure to be sorted. Must be an iterable.
        condition (optional): A function to determine the sorting order. If provided, the elements are sorted based on the result of applying this function to each element. Default is the identity function. (default: lambda x: x)
        reverse (optional): Specifies whether to sort in reverse order. If True, the data structure is sorted in descending order. If False, the data structure is sorted in ascending order. Default is False. (default: False)
        sort_dicts_by (optional): Specifies how to sort dictionaries. If 'keys', dictionaries are sorted by their keys. If 'values', dictionaries are sorted by their values. If None, dictionaries are not sorted. Default is 'keys'. (default: 'keys')
        sort_iters (optional): Specifies whether to sort iterable types (e.g., generator, range). If True, iterable types are sorted. If False, iterable types are not sorted. Default is True. (default: True)
        sort_lists (optional): Specifies whether to sort lists. If True, lists are sorted. If False, lists are not sorted. Default is True. (default: True)
        sort_sets (optional): Specifies whether to sort sets. If True, sets are sorted. If False, sets are not sorted. Default is True. (default: True)
        sort_tuples (optional): Specifies whether to sort tuples. If True, tuples are sorted. If False, tuples are not sorted. Default is True. (default: True)
...
def xor(*values, condition=bool):
    ...
    Args:
        *values: Multiple values to perform the XOR operation on. At least two values are required.
        condition (optional): A function to determine the truthiness of each value. Values that evaluate to True are considered for the XOR operation. Default is the bool function. (default: bool)

    Returns:
        The only truthy value that satisfies the XOR condition based on the condition function, or None if no such value is found.
...
def xor_with_idx(*values, condition=bool):
    """
    Performs an exclusive OR (XOR) operation on multiple values using a condition function and returns the index-value pair of the first satisfying value.
    ...
    Returns:
        A tuple containing the index and value of the first value that satisfies the XOR condition based on the condition function, or None if no such value is found.
