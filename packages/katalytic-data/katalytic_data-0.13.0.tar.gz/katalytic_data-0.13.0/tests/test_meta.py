...
from katalytic.data.meta import extract_call_stack_info, reference_caller_function, reference_current_function
...
class Test_reference_current_function:
    def test_should_be_equivalent_to_reference_caller_function_with_depth_0(self):
        ...
        caller_0 = reference_caller_function(depth=0)

        assert current is not None
        assert current is caller_0
