...
def compute_components(*args, **kwargs):
    """
    compute_components(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.ComponentOptions = <lagrange.core.ComponentOptions object at 0x000001EB9A59D620>) -> int
    """
    ...
...
def compute_facet_area(*args, **kwargs):
    """
    compute_facet_area(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.FacetAreaOptions = <lagrange.core.FacetAreaOptions object at 0x000001EB9A59D410>) -> int
    """
    ...

def compute_facet_centroid(*args, **kwargs):
    """
    compute_facet_centroid(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.FacetCentroidOptions = <lagrange.core.FacetCentroidOptions object at 0x000001EB9A59D2F0>) -> int
    """
    ...

def compute_facet_normal(*args, **kwargs):
    """
    compute_facet_normal(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.FacetNormalOptions = <lagrange.core.FacetNormalOptions object at 0x000001EB9A54CE40>) -> int
    """
    ...

def compute_mesh_area(*args, **kwargs):
    """
    compute_mesh_area(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.MeshAreaOptions = <lagrange.core.MeshAreaOptions object at 0x000001EB9A59D380>) -> float
    """
    ...

def compute_mesh_centroid(*args, **kwargs):
    """
    compute_mesh_centroid(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.MeshCentroidOptions = <lagrange.core.MeshCentroidOptions object at 0x000001EB9A5B92B0>) -> list[float]
    """
    ...
...
def compute_tangent_bitangent(*args, **kwargs):
    """
    compute_tangent_bitangent(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.TangentBitangentOptions = <lagrange.core.TangentBitangentOptions object at 0x000001EB9A585770>) -> lagrange.core.TangentBitangentResult
    """
    ...

def compute_vertex_normal(*args, **kwargs):
    """
    compute_vertex_normal(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.VertexNormalOptions = <lagrange.core.VertexNormalOptions object at 0x000001EB9A5B18E0>) -> int
    """
    ...

def compute_vertex_valence(*args, **kwargs):
    """
    compute_vertex_valence(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.VertexValenceOptions = <lagrange.core.VertexValenceOptions object at 0x000001EB9A59D560>) -> int
    """
    ...
...
def remap_vertices(*args, **kwargs):
    """
    remap_vertices(mesh: lagrange.core.SurfaceMesh, old_to_new: numpy.typing.NDArray, options: lagrange.core.RemapVerticesOptions = <lagrange.core.RemapVerticesOptions object at 0x000001EB9A571B50>) -> None
    """
    ...
