...
def validate_cycle(cycle: dict, node_map: dict = {}):
    ...
    return flatten([
        ...
        ([
            ...
            validate_duplicated_term_units(cycle, 'inputs', [TermTermType.ORGANICFERTILISER])
        ...
        ([
            ...
            validate_duplicated_term_units(cycle, 'products', [TermTermType.ORGANICFERTILISER])
