...
class HAVOC:
    ...
    def __init__(self, slide, feature_extractor_path, out_dir, tile_size=512, safe_mpp=False, hd_backdrop=False):
        ...
        self.te = TileExtractor(slide, tile_size, safe_mpp=safe_mpp)
