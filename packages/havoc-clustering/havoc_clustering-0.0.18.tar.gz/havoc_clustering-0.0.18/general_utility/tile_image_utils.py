...
if __name__ == '__main__':
    ...
    fps = glob.glob(
        '/media/pdiamandis/brAIn out/brAIn/brAIn output/Autotiler/Autotiled_imgs_only_lesion_85/1024/brain_p53/brain_p53_train/Wildtype/*')
    random.shuffle(fps)

    res = TileUtils.make_image_vector_using_tiles([cv2.imread(x) for x in fps[:20]])

    cv2.imwrite(
        '/media/pdiamandis/brAIn out/brAIn/brAIn output/Autotiler/Autotiled_imgs_only_lesion_85/1024/brain_p53/brain_p53_train/wildtypevec.jpg',
        res)
