...
class PwcSignals:
    ...
    def tanh_ramp_pwc(
        ...
        :func:`~Graph.tanh` : Calculate the element-wise hyperbolic tangent of an object.
    ...
    def cosine_pulse_pwc(
        ...
        :func:`~signals.square_pulse_pwc` : Create a `Pwc` representing a square pulse.
        :func:`~Graph.cos` : Calculate the element-wise cosine of an object.
    ...
    def sinusoid_pwc(
        ...
        :func:`~Graph.sin` : Calculate the element-wise sine of an object.
