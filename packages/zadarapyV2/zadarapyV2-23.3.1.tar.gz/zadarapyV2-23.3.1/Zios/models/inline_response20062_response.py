...
class InlineResponse20062Response(object):
    ...
    swagger_types = {
        'message': 'str',
        'status': 'int',
        'user': 'InlineResponse20062ResponseUser'
    }
    ...
    @property
    def user(self):
        """Gets the user of this InlineResponse20062Response.  # noqa: E501


        :return: The user of this InlineResponse20062Response.  # noqa: E501
        :rtype: InlineResponse20062ResponseUser
        """
        return self._user

    @user.setter
    def user(self, user):
        """Sets the user of this InlineResponse20062Response.


        :param user: The user of this InlineResponse20062Response.  # noqa: E501
        :type: InlineResponse20062ResponseUser
        """
