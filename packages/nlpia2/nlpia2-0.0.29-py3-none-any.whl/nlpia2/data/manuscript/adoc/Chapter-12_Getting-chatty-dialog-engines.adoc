...
You learned in Chapter 9 and 10 the importance of human feedback to help train your NLP models to get smarter and smarter over time.
You can increase your chatbot's breadth of knowledge by add new branches in the dialog tree.
And you can increase a chatbots ability to understand what your users are saying by finding and labeling utterances that your chatbot misunderstood.
...
A data driven organization pays attention to their users and builds what they need, rather than what they _think_ the users need.
...
There's nothing worse than having a chatbot that is always falling back to it's "I don't understand" response.
...
The users interactions are then recorded in a message log and analyzed to help inform the conversation design and data labeling steps at the top of the diagram.

[TIP]
====
In any organization building chatbots nearly everyone will have an opinion about what your chatbot should.
