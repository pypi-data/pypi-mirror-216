...
According to the philosopher Douglas Hofstader, the border between intelligent and non-intelligent behavior is not easily distinguishable. footnote[Douglas R. Hofstadter, "Gödel, Escher, Bach: an Eternal Golden Braid (GEB), p. 26]

In his book "Gödel, Escher, Bach" Hofstadter explains how machines and even software can be intelligent. 
He suggests that for a machine (or piece of software) to be intelligent it must:
...
HL: Didn't have time to add this additional material, so I moved these TODOs to a separate note for myself.
////
