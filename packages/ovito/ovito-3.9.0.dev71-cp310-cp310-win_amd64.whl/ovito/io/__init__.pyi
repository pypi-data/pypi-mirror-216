...
user interface. The format of the imported file is automatically detected (see list of supported formats - also including registered user-defined file readers).
