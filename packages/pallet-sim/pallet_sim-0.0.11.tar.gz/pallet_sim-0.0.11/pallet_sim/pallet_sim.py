...
def main():
    ...
    path = pkg_resources.resource_filename(__name__, rf"examples/{code}")
...
def pybullet_and_mujoco_test():
    ...
    if not pallet_sim.load(json_data=pkg_resources.resource_filename(__name__, rf"./examples/{code}.order.json")):
