...
NAME = "pop_serial"
DESC = "An app-merge component for larger projects that provides a standardized interface for serializing and de-serializing data."

# Version info -- read without importing
_locals = {}
with pathlib.Path("pop_serial", "version.py").open() as fp:
...
setup(
    ...
    url="https://gitlab.com/vmware/idem/pop-serial",
    project_urls={
        "Code": "https://gitlab.com/vmware/idem/pop-serial",
        "Issue tracker": "https://gitlab.com/vmware/idem/pop-serial/issues",
    },
    version=VERSION,
