...
def detect_media_type(filename):
  ...
  assert fs_tools.exists(filename), f'{filename} not found.'
  ...
  sys_cmd = FFPROBE_EXE + ' -v error -show_entries format=format_name -of default=noprint_wrappers=1:nokey=1 ' + filename
