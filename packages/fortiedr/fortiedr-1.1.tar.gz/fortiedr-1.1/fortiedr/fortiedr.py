...
class Events:
	...
	def insert_events(self, eventIds :dict = None, collectorGroups :dict = None, deviceIps :dict = None, macAddresses :dict = None, severities :dict = None, classifications :dict = None, actions :dict = None, paths :dict = None, operatingSystems :dict = None, destinations :dict = None, eventType :dict = None, pageNumber :int = None, strictMode :bool = None, itemsPerPage :int = None, sorting :str = None, organization :str = None, device :str = None, process :str = None, fileHash :str = None, firstSeen :str = None, lastSeen :str = None, firstSeenFrom :str = None, firstSeenTo :str = None, lastSeenFrom :str = None, lastSeenTo :str = None, seen :bool = None, handled :bool = None, rule :str = None, loggedUser :str = None, archived :bool = None, signed :bool = None, muted :bool = None, deviceControl :bool = None, expired :bool = None, archive: bool = None, classification: str = None, comment: str = None, familyName: str = None, forceUnmute: bool = None, handle: bool = None, malwareType: str = None, mute: bool = None, muteDuration: str = None, read: bool = None, threatName: str = None) -> tuple[bool, None]:
		...
		:param archive: A true/false parameter indicating whether to update archived events. Example: archive=False.
		...
		:param forceUnmute: Indicates whether to force archive even if the event is muted. Example: forceUnmute=False.
		:param handle: A true/false parameter indicating update the events handled/unhandled. Example: handle=False.
		:param malwareType: Specifies the event malware type. 
		:param mute: A true/false parameter indicating whether to mute events. Example: mute=False.
		:param muteDuration: Specifies the mute duration time. 
		:param read: A true/false parameter indicating whether the events are read/unread by the user operating the API. Example: read=False.
...
class Organizations:
	...
	def create_organization(self, expirationDate: str, name: str, password: str, passwordConfirmation: str, eXtendedDetection: bool = None, edr: bool = None, edrAddOnsAllocated: int = None, edrBackupEnabled: bool = None, edrEnabled: bool = None, edrNumberOfShards: int = None, edrStorageAllocatedInMb: int = None, forensics: bool = None, iotAllocated: int = None, requestPolicyEngineLibUpdates: bool = None, serialNumber: str = None, serversAllocated: int = None, vulnerabilityAndIoT: bool = None, workstationsAllocated: int = None) -> tuple[bool, None]:
		...
		:param eXtendedDetection: A true/false parameter indication if the eXtended Detection is enabled for the organization. Example: eXtendedDetection=False.
		:param edr: A true/false parameter indicating whether the organization support Threat Hunting. Example: edr=False.
		:param edrAddOnsAllocated: Specifies the EDR storage add-ons allocated to this account. 
		:param edrBackupEnabled: A true/false parameter indication if the EDR backup is enabled for the organization. Example: edrBackupEnabled=False.
		:param edrEnabled: A true/false parameter indication if the EDR is enabled for the organization. Example: edrEnabled=False.
		...
		:param forensics: A true/false parameter indicating whether the organization support Forensics. Example: forensics=False.
		:param iotAllocated: Specifies the IoT devices license capacity. 
		...
		:param requestPolicyEngineLibUpdates: A true/false parameter indicating whether the organization collectors should request for policy engine lib updates. Example: requestPolicyEngineLibUpdates=False.
		:param serialNumber: Specifies the serial number. 
		:param serversAllocated: Specifies the server collectors license capacity. 
		:param vulnerabilityAndIoT: A true/false parameter indicating whether the organization support Vulnerability And IoT. Example: vulnerabilityAndIoT=False.
		:param workstationsAllocated: Specifies the workstation collectors license capacity. 
...
class ThreatHunting:
	...
	def customize_fortinet_query(self, id :int = None, queryToEdit :str = None, dayOfMonth: int = None, dayOfWeek: int = None, forceSaving: bool = None, frequency: int = None, frequencyUnit: str = None, fromTime: str = None, hour: int = None, organization: str = None, scheduled: bool = None, state: bool = None, time: str = None, toTime: str = None) -> tuple[bool, None]:
		...
		:param forceSaving: A true/false parameter indicating whether to force the save, even when there is a large quantity of query results. Example: forceSaving=False.
		...
		:param organization: Specifies the name of a specific organization. The value that you specify here must match exactly. 
		:param scheduled: Specifies whether the query is scheduled. False by default. Example: scheduled=False.
		:param state: A true/false parameter indicating whether the query state is enabled. True by default. Example: state=False.
	...
	def save_query(self, id :int = None, queryToEdit :str = None, category: str = None, classification: str = None, collectorNames: dict = None, community: bool = None, dayOfMonth: int = None, dayOfWeek: int = None, description: str = None, forceSaving: bool = None, frequency: int = None, frequencyUnit: str = None, fromTime: str = None, hour: int = None, name: str = None, organization: str = None, query: str = None, scheduled: bool = None, state: bool = None, tagIds: dict = None, tagNames: dict = None, time: str = None, toTime: str = None) -> tuple[bool, None]:
		...
		:param community: A true/false parameter indicating whether the query is available to the entire FortiEDR Community. False by default. Example: community=False.
		:param dayOfMonth: Specifies the day of the month for the scheduled query. The value must be between 1 and 28. The properties scheduled and frequencyUnit must be true and Month respectively. 
		:param dayOfWeek: Specifies the day of the week for the scheduled query. The value must be between 0 and 6. 0 is Sunday and 6 is Saturday. The properties scheduled and frequencyUnit must be true and Week respectively. 
...
class Users:
	...
	def create_user(self, confirmPassword: str, email: str, firstName: str, lastName: str, password: str, role: str, username: str, organization :str = None, customScript: bool = None, remoteShell: bool = None, restApi: bool = None, title: str = None) -> tuple[bool, None]:
		...
		:param customScript: Is user can upload custom scripts. Example: customScript=False.
		...
		:param remoteShell: Is user can use remote shell. Example: remoteShell=False.
		:param restApi: Is user can access by rest to the api. Example: restApi=False.
	...
	def update_saml_settings(self, groupAttribute : str, enabled : bool, ssoUrl : str, organization :str = None, metadataUrl :str = None, idpMetadataFile :object = None, apiGroupName :str = None, hostGroupName :str = None, localAdminGroupName :str = None, usersGroupName :str = None, description :str = None) -> tuple[bool, None]:
		...
		:param organization: Specifies the organization. The value that you specify for this parameter indicates how the operation applies to an organization(s). Some parts of the Fortinet Endpoint Protection and Response Platform system have separate, non shared data that is organization-specific. Other parts of the system have data that is shared by all organizations. The value that you specify for the organization parameter, as described below, determines to which organization(s) an operation applies: Exact organization name  Specifies the name of a specific organization. The value that you specify here must match exactly. All organizations  Indicates that the operation applies to all organizations. In this case, the same data is shared by all organizations.. 
		:param metadataUrl: IDP metadata url path. 
		:param idpMetadataFile: IDP metadata file. 
		:param groupAttribute: Group attribute for parsing SAML assertion. 
		:param apiGroupName: IDP's group name that should be mapped to API role. 
		:param hostGroupName: IDP's group name that should be mapped to ADMIN role. 
		:param localAdminGroupName: IDP's group name that should be mapped to LOCAL ADMIN role. 
		:param usersGroupName: IDP's group name that should be mapped to USER role. 
		:param enabled: Indicates whether the SAML configuration is enabled. 
		:param description: Description of the SAML configuration. 
		:param ssoUrl: Specify the SSO url postfix. 
