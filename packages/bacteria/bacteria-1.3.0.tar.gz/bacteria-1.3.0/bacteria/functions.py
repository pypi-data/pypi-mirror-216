...
def combined_filters(df_2d, df_3d, std = 1, daughter = True, length = True, plot=False):
    """
    ...
    daughter : bool (optional)
        ...
        alongised with 'length' the two filters will be used
    length : bool (optional)
        If True the length filter will be used. If True
    ...
    # Filters
    if daughter == True and length == True:
        gc_filter = natsorted(list(set(good_cells_d) & set(good_daughters)))
    elif daughter == True and length == False:
        gc_filter = natsorted(set(good_daughters))
    elif length == False and length == True:
