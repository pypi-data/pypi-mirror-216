...
class CiscoDeviceSupport(ChangeLoggedModel):
    ...
    def coverage_progress(self):
        ...
        """
        return self.coverage_elapsed / self.coverage_total * 100 if self.coverage_end_date else None
    ...
    def coverage_progress_bar_class(self):
        ...
        """
        if self.coverage_end_date:
            if self.coverage_remaining < 30:
                return "bg-danger"
            if self.coverage_remaining < 90:
                return "bg-warning"
        return "bg-success"
    ...
    def partner_coverage_progress(self):
        ...
        """
        return (
            self.partner_coverage_elapsed / self.partner_coverage_total * 100
            if self.partner_coverage_end_date
            else None
        )
    ...
    def partner_coverage_progress_bar_class(self):
        ...
        """
        if self.partner_coverage_end_date:
            if self.partner_coverage_remaining < 30:
                return "bg-danger"
            if self.partner_coverage_remaining < 90:
                return "bg-warning"
        return "bg-success"
