...
class DbSync:
    ...
    def query(self, query, params=None, require_database=True, ignore_rowcount=False, execute_many=False):
    ...
    def bulk_insert_records(
        ...
        values = [tuple(record[key] for key in keys) for record in records.values()]
