                        ...
                        if p_data["subject"] == 'MATCH':
                            ...
                            for index, team in enumerate(e_data['teams']):
                                ...
                                for participant in team['participants']:
                                    ...
                                    elif participant["urn"] == "live:lol:riot:player:65403cb3-1cb9-34eb-b533-cf9486b66229":
                                        participant["urn"] = "live:lol:riot:player:1f65f189-52ea-33c8-aede-b7f7e2ea6cda"
                                    p = Player(participant)
                                    # print(p.urn)
