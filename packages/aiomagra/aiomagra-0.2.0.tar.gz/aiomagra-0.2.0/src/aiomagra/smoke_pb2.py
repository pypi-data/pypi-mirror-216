...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _SMOKEDETECTORMAINTENANCE._serialized_start=525
  _SMOKEDETECTORMAINTENANCE._serialized_end=667
  _SMOKEREPORT._serialized_start=35
  _SMOKEREPORT._serialized_end=207
