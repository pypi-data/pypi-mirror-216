...
import pagarmecoreapi.models.create_clear_sale_request
...
class CreateAntifraudRequest(object):
    ...
    def from_dictionary(cls,
        ...
        clearsale = pagarmecoreapi.models.create_clear_sale_request.CreateClearSaleRequest.from_dictionary(dictionary.get('clearsale')) if dictionary.get('clearsale') else None
