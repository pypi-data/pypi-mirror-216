...
import pagarmecoreapi.models.get_withdraw_source_response
import pagarmecoreapi.models.get_withdraw_target_response
...
class GetWithdrawResponse(object):
    ...
    def from_dictionary(cls,
        ...
        source = pagarmecoreapi.models.get_withdraw_source_response.GetWithdrawSourceResponse.from_dictionary(dictionary.get('source')) if dictionary.get('source') else None
        target = pagarmecoreapi.models.get_withdraw_target_response.GetWithdrawTargetResponse.from_dictionary(dictionary.get('target')) if dictionary.get('target') else None
