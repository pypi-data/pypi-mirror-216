...
import pagarmecoreapi.models.create_emv_data_decrypt_request
import pagarmecoreapi.models.create_card_payment_contactless_poi_request
...
class CreateEmvDecryptRequest(object):
    ...
    def from_dictionary(cls,
        ...
        data = pagarmecoreapi.models.create_emv_data_decrypt_request.CreateEmvDataDecryptRequest.from_dictionary(dictionary.get('data')) if dictionary.get('data') else None
        poi = pagarmecoreapi.models.create_card_payment_contactless_poi_request.CreateCardPaymentContactlessPOIRequest.from_dictionary(dictionary.get('poi')) if dictionary.get('poi') else None
