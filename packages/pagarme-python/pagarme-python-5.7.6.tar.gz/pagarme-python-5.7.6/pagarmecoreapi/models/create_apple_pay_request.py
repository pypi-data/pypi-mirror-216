...
import pagarmecoreapi.models.create_apple_pay_header_request
...
class CreateApplePayRequest(object):
    ...
    def from_dictionary(cls,
        ...
        header = pagarmecoreapi.models.create_apple_pay_header_request.CreateApplePayHeaderRequest.from_dictionary(dictionary.get('header')) if dictionary.get('header') else None
