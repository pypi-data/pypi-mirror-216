...
import pagarmecoreapi.models.get_gateway_error_response
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('errors') != None:
            ...
            for structure in dictionary.get('errors'):
                errors.append(pagarmecoreapi.models.get_gateway_error_response.GetGatewayErrorResponse.from_dictionary(structure))
