...
import pagarmecoreapi.models.create_google_pay_header_request
...
class CreateGooglePayRequest(object):
    ...
    def from_dictionary(cls,
        ...
        header = pagarmecoreapi.models.create_google_pay_header_request.CreateGooglePayHeaderRequest.from_dictionary(dictionary.get('header')) if dictionary.get('header') else None
