...
import pagarmecoreapi.models.get_three_d_secure_response
...
class GetPaymentAuthenticationResponse(object):
    ...
    def from_dictionary(cls,
        ...
        threed_secure = pagarmecoreapi.models.get_three_d_secure_response.GetThreeDSecureResponse.from_dictionary(dictionary.get('threed_secure')) if dictionary.get('threed_secure') else None
