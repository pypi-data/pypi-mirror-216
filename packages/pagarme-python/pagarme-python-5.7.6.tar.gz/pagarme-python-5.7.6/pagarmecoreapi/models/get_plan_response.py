...
import pagarmecoreapi.models.get_plan_item_response
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('items') != None:
            ...
            for structure in dictionary.get('items'):
                items.append(pagarmecoreapi.models.get_plan_item_response.GetPlanItemResponse.from_dictionary(structure))
