...
import pagarmecoreapi.models.list_usages_details_response
...
class GetUsagesDetailsResponse(object):
    ...
    def from_dictionary(cls,
        ...
        usages = pagarmecoreapi.models.list_usages_details_response.ListUsagesDetailsResponse.from_dictionary(dictionary.get('Usages')) if dictionary.get('Usages') else None
        period = pagarmecoreapi.models.get_period_response.GetPeriodResponse.from_dictionary(dictionary.get('Period')) if dictionary.get('Period') else None
