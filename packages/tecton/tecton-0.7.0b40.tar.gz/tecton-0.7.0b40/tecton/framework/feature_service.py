...
class FeatureService(base_tecton_object.BaseTectonObject):
    ...
    def __init__(
        ...
        *,
        ...
        online_compute: Optional[configs.OnlineComputeConfig] = None,
    ):
        """
        ...
        args = feature_service__args_pb2.FeatureServiceArgs(
            ...
            on_demand_online_compute=online_compute._to_proto()
            if online_compute
            else configs.ColocatedComputeConfig()._to_proto(),
        )
