...
from tecton_proto.common import odfv_compute_pb2
...
@attrs.define(auto_attribs=True)
class ColocatedComputeConfig:
    def _to_proto(self) -> odfv_compute_pb2.OnlineComputeConfig:
        return odfv_compute_pb2.OnlineComputeConfig(colocated_compute=odfv_compute_pb2.ColocatedComputeConfig())


@attrs.define(auto_attribs=True)
class RemoteComputeConfig:
    def _to_proto(self):
        return odfv_compute_pb2.OnlineComputeConfig(remote_compute=odfv_compute_pb2.RemoteComputeConfig())


OnlineComputeConfig = Union[ColocatedComputeConfig, RemoteComputeConfig]
