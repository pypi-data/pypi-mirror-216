...
class Dashboards(Snowflake):
    ...
    def InclusionExclusion(self):
        ...
        return InclusionExclusion(username=self.username, warehouse=self.warehouse, role=self.role,
                                  database=self.database)

    @property
    def IMP(self):
        from Dashboards.IMP.IMP import IMP
        return IMP(username=self.username, warehouse=self.warehouse, role=self.role, database=self.database)
