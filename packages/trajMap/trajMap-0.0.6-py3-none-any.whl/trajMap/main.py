...
def lineagePredict(adata,chondroPath=scanviChondroFile,mesPath=scanviMesFile,leprPath=scanviLeprFile,max_epoch=100):
...
def pseduo_predict(adata,modelPath=pseduoPredFile):
    #==load model================
...
#== integrate adata-----------------
def integrateTrajMap(adata,mapPath=trajMapFile):
