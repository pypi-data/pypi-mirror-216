...
class DataDatabricksNotebookPaths(
    ...
    def __init__(
        ...
        *,
        ...
        :param path: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.20.0/docs/data-sources/notebook_paths#path DataDatabricksNotebookPaths#path}.
        :param recursive: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.20.0/docs/data-sources/notebook_paths#recursive DataDatabricksNotebookPaths#recursive}.
