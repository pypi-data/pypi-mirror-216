...
def data_span(data: np.array) -> float:
    """
...
def gaussian_discrete_movement(amp: float=1.0, dur: float=1.0, loc: float=0.,
                               time: np.array=np.arange(-0.5, 0.5, 0.01),
                               data_type: str='vel') -> np.array:
    """
...
def gaussian_rhytmic_movement(amp: float, dur: float, interval: float,
                              ts: float, n_movements: int) -> tuple[np.array, np.array]:
    """
...
def generate_random_movement(move_type: str='gaussian') -> tuple[np.array, np.array, np.array]:
    """
...
def generate_movement(Ns: int, amp: np.array, dT: np.array, T: np.array,
                      ts: float=0.001, move_type: str='gaussian',
                      data_type: str='vel') -> tuple[np.array, np.array, np.array]:
    """
...
def get_movement_endtime(dT: float, T: np.array):
    """
