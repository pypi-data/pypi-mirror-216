...
class Jump:
    ...
    async def get_images(self, itmes_id):
        ...
        keys_image_mini = items.get("artPath","510efbbb2217f1acfe3538a9849f7e57bcfcd61d0fa78bb1e66e563f9bf52ab6")
        keys_image_full = items.get("iconPath","510efbbb2217f1acfe3538a9849f7e57bcfcd61d0fa78bb1e66e563f9bf52ab6")
