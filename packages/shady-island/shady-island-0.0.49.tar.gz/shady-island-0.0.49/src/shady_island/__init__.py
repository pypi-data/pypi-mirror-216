...
class BaseDatabaseProps(BaseDatabaseOptions):
    def __init__(
        ...
        *,
        ...
        resource: _constructs_77d1e7e8.Construct,
        ...
        :param resource: The database cluster (used for CloudFormation dependencies).
    ...
    @builtins.property
    def resource(self) -> _constructs_77d1e7e8.Construct:
...
class MysqlDatabase(
    ...
    def _trigger(self) -> _aws_cdk_triggers_ceddda9d.Trigger:
        return typing.cast(_aws_cdk_triggers_ceddda9d.Trigger, jsii.get(self, "trigger"))
