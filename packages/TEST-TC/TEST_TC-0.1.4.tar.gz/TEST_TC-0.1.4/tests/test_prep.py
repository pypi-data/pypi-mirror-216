...
def test_preprocessing_class_fit_transform(usecase,model,col1,col2):
    ...
    example_data = pd.DataFrame({col1: pd.to_datetime(['2023-06-01', '2023-06-02', '2023-06-03']), col2: ['A', 'B', 'C']})
    example_data_num2 = pd.DataFrame({col1: pd.to_datetime(['2023-06-01', '2023-06-02', '2023-06-02']), col2: ['A', 'B', 'C']})
    ...
    result = preprocessing.fit_transform(example_data)
    ...
    result = preprocessing.fit_transform(example_data_num2)
    expected = pd.DataFrame({'Timestamp':  pd.to_datetime(['2023-06-01', '2023-06-02']), 'Target': [1,2]})
