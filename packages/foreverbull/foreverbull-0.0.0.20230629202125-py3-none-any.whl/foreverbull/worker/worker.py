...
from foreverbull.models.service import Request, Response
...
class Worker:
    ...
    def configure(self, configuration: models.backtest.Execution):
        ...
        while True:
            try:
                ...
                if request.task == "configure":
                    configuration = models.backtest.Execution(**request.data)
                    self.configuration = configuration
