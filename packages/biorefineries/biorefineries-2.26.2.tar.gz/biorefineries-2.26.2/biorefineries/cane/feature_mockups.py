...
(MFPP, MESP, MBSP, feedstock_consumption, biodiesel_production, biodiesel_yield, ethanol_production, 
 ...
 # energy_competitive_microbial_oil_yield,
    ...
    MockFeature('GWP derivative', 'kg*CO2*eq / L', 'Ethanol'),
    MockFeature('GWP derivative', 'kg*CO2*eq / L', 'Biodiesel'),
    MockFeature('GWP derivative', 'kg*CO2*eq / kg', 'Crude glycerol'),
    MockFeature('GWP derivative', 'kg*CO2*eq / MWhr', 'Electricity'),
    MockFeature('ROI', '%', ''),
