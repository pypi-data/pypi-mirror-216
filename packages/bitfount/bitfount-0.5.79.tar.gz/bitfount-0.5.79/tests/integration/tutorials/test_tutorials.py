...
CENSUS_INCOME_POD_NAME: Final[str] = "census-income-pod"
CENSUS_INCOME_DATASET_NAME: Final[str] = "census-income-demo"

CENSUS_INCOME_YAML_POD_NAME: Final[str] = "census-income-yaml-pod"
CENSUS_INCOME_YAML_DATASET_NAME: Final[str] = "census-income-yaml-demo"

MNIST_POD_NAME: Final[str] = "mnist-pod"
MNIST_DATASET_NAME: Final[str] = "mnist-demo"

SEGMENTATION_POD_NAME: Final[str] = "segmentation-data-pod"
SEGMENTATION_DATASET_NAME: Final[str] = "segmentation-data-demo"

PSI_POD_NAME: Final[str] = "psi-pod"
PSI_DATASET_NAME: Final[str] = "psi-demo"
...
def census_income_dataset_name(pod_suffix: str) -> str:
    ...
    dataset_name = f"{CENSUS_INCOME_DATASET_NAME}-{pod_suffix}"
    logger.info(f"Census income pod name: {dataset_name}")
    return dataset_name
...
def census_income_yaml_dataset_name(pod_suffix: str) -> str:
    """Name of the census income dataset."""
    dataset_name = f"{CENSUS_INCOME_YAML_DATASET_NAME}-{pod_suffix}"
    logger.info(f"Census income yaml pod name: {dataset_name}")
    return dataset_name
...
def mnist_dataset_name(pod_suffix: str) -> str:
    ...
    mnist_dataset_name = f"{MNIST_DATASET_NAME}-{pod_suffix}"
    logger.info(f"MNIST pod name: {mnist_dataset_name}")
...
def seg_dataset_name(pod_suffix: str) -> str:
    ...
    seg_dataset_name = f"{SEGMENTATION_DATASET_NAME}-{pod_suffix}"
    logger.info(f"Segmentation pod name: {seg_dataset_name}")
...
def psi_dataset_name(pod_suffix: str) -> str:
    """Name of the Segmentation dataset."""
    psi_dataset_name = f"{PSI_DATASET_NAME}-{pod_suffix}"
    logger.info(f"Segmentation pod name: {psi_dataset_name}")
