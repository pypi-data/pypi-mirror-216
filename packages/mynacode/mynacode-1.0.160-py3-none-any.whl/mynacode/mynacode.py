...
def save_results(run_id, y_true, y_predicted, node_name="Results", problem_type = 'binary classification', hist_bins=20):
    ...
    data = {'run_id' : run_id, 'precision': round(prec, 4), 'recall': round(rec, 4), 'specificity': round(spec, 4),
            ...
            'username': username, 'node_name': node_name, 'key': key, 'test_auc': roc_auc, 'freq': freq, 'bins': hist_bins,
            'fpr': fpr, 'tpr': tpr}   
