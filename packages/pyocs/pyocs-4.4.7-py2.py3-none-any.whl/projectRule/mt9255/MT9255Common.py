...
class MT9255Common(UniteInterface):
    ...
    def get_board_macro(self):
        ...
        board_macro = "ID_BD_TP_" + main_project + "_" + board_type + "_SUB_" + sub_board_type
    ...
    def get_chip_macro(self):
        ...
        chip_macro = "ID_CHIP_" + chip_type + 'ZA'
    ...
    def get_bluetooth_macro(self):
        ...
        if 'WB7638U' in demand_str:
            ret += "#define CVT_EN_BLUETOOTH".ljust(self._space) + '1' + '\n'
            ret += "#define CVT_DEF_BLUETOOTH_TYPE".ljust(self._space) + "ID_BLUETOOTH_TYPE_MT7638" + '\n'
        elif 'WB8723DU' in demand_str:
            ret += "#define CVT_EN_BLUETOOTH".ljust(self._space) + '1' + '\n'
            ret += "#define CVT_DEF_BLUETOOTH_TYPE".ljust(self._space) + "ID_BLUETOOTH_TYPE_RTK8761" + '\n'
        elif 'WB800D' in demand_str:
            ret += "#define CVT_EN_BLUETOOTH".ljust(self._space) + '1' + '\n'
            ret += "#define CVT_DEF_BLUETOOTH_TYPE".ljust(self._space) + "ID_BLUETOOTH_TYPE_AIC8800D" + '\n'
        return ret
