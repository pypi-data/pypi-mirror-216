...
class CraftAiSdk:
    ...
    _version = "0.21.0"  # Would be better to share it somewhere
    ...
    def execute_pipeline(self, pipeline_name):
        ...
        Returns:
            ...
            * ``"execution_id"`` (:obj:`str`): Id of the created pipeline execution.
        """
        warnings.warn(
...
/executions/{execution_id}/outputs/{output_name}"
    ...
    def create_deployment(
        ...
        Warning:
            The periodic deployment execution rule is experimental and may be unstable.
...
'periodic'."
                ...
                warnings.warn(
                    "The periodic deployment execution rule is experimental and may be \
unstable.",
                    Warning,
                )
    ...
    def delete_endpoint(self, endpoint_name):
        ...
        Returns:
            :obj:`dict`: Deleted endpoint represented as dict with the following keys:

            * ``"name"`` (:obj:`str`): Name of the endpoint.
            * ``"type"`` (:obj:`str`): Endpoint.
        """
        warnings.warn(
    ...
    def record_metric_value(self, name, value):
        ...
        Returns:
            None
        """
        warnings.warn("This function is experimental and may change in the future")
