...
class HttpError(Exception):
    ...
    __status: http.HTTPStatus | None = None
    ...
    @property
    def status(self) -> http.HTTPStatus | None:
...
class HttpResponse:
    ...
    def from_json(self, json_path: list[str] | None = None) -> dict:
...
RetryWaitFn = typing.Callable[[BaseException | None], float]
...
class HttpRequest:
    ...
    def __init__(
        ...
        data: typing.Any = None,
        retry_wait: RetryWaitFn | None = None,
    ):
        self.url = url
        self.method = method
...
class HttpClient:
    ...
    __default_auth: HttpRequestDecorator | None
    __default_endpoint: str | None

    def __init__(
        self,
        base_headers: dict[str, str] | None = None,
        default_endpoint: str | None = None,
        default_auth: HttpRequestDecorator | None = None,
    ):
    ...
    def delete(
        self, url, data: typing.Any = None, headers: dict | None = None
    ) -> HttpResponse:
