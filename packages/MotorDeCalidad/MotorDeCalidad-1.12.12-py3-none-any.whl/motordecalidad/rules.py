...
def validateRequisites(object:DataFrame, field:list):
    ...
    if len(error_list) == Zero and rowsNumber != Zero :
        ...
        return (rowsNumber,Rules.Pre_Requisites.code,Rules.Pre_Requisites.name,Rules.Pre_Requisites.property,Rules.Pre_Requisites.code + "/" + fields,"100","Error en esquema de la tabla",fields,"0.00",rowsNumber)
