...
def validateRequisites(object:DataFrame, field:list):
    ...
    if len(error_list) == Zero and rowsNumber != Zero :
        ...
        return  [rowsNumber,Rules.Pre_Requisites.code,Rules.Pre_Requisites.name,Rules.Pre_Requisites.property,Rules.Pre_Requisites.code + "/" + field,"100","Validación de PreRequesitos Exitosa",field,"100","0"]
        ...
        return [rowsNumber,Rules.Pre_Requisites.code,Rules.Pre_Requisites.name,Rules.Pre_Requisites.property,Rules.Pre_Requisites.code + "/" + field,"100","Error en esquema de la tabla",field,"0",rowsNumber]
    elif rowsNumber == Zero :
        inform("El dataframe de entrada no contiene registros")
        return [rowsNumber,Rules.Pre_Requisites.code,Rules.Pre_Requisites.name,Rules.Pre_Requisites.property,Rules.Pre_Requisites.code + "/" + field,"100","DataFrame no contiene Registros",field,"0",rowsNumber]
