...
def validateRequisites(object:DataFrame, field:list):
    ...
    if len(error_list) == Zero and rowsNumber != Zero :
        ...
        return (rowsNumber,Rules.Pre_Requisites.code,Rules.Pre_Requisites.name,Rules.Pre_Requisites.property,Rules.Pre_Requisites.code + "/" + fields,"100","Validación de PreRequesitos Exitosa",fields,"100.00",0)
        ...
        return (rowsNumber,Rules.Pre_Requisites.code,Rules.Pre_Requisites.name,Rules.Pre_Requisites.property,Rules.Pre_Requisites.code + "/" + fields,"100",f"Error en esquema de la tabla, reviar los siguientes campos: {','.join(error_list)}",fields,"0.00",rowsNumber)
