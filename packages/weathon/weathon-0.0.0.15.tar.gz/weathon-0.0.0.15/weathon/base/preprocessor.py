...
from weathon.utils.constants import ModeKeys, DEFAULT_MODEL_REVISION, Invoke, Tasks
from weathon.utils.constants.metainfo import PREPROCESSOR_MAP
...
class BasePreprocessor(ABC):
    ...
    def from_pretrained(cls,
        ...
        Examples:
            >>> from weathon.base.preprocessor import Preprocessor
