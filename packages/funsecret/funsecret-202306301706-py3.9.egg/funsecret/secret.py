...
class SecretManage(BaseTable):
    def __init__(self, secret_dir=None, url=None, cipher_key=None, *args, **kwargs):
        ...
        super(SecretManage, self).__init__(
            table_name='secret_manage', engine=engine, *args, **kwargs)
        self.table = Table(self.table_name, meta,
                           # Column('secret_key', String(100), comment='secret_key'),
                           Column('cate1', String, comment='cate1',
                                  default='', primary_key=True),
                           Column('cate2', String, comment='cate2',
                                  default='', primary_key=True),
                           Column('cate3', String, comment='cate3',
                                  default='', primary_key=True),
                           Column('cate4', String, comment='cate4',
                                  default='', primary_key=True),
                           Column('cate5', String, comment='cate4',
                                  default='', primary_key=True),
                           Column('value', String, comment='value', default=''),
                           Column('expire_time', BIGINT,
                                  comment='expire_time', default=9999999999),
    ...
    def read(self, cate1, cate2='', cate3='', cate4='', cate5='', value=None, save=True, secret=False,
             expire_time=None):
        """
...
def read_secret(cate1, cate2='', cate3='', cate4='', cate5='', value=None, save=True, secret=False,
                expire_time=9999999):
    manage = SecretManage()
    manage.create()
