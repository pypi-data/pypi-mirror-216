...
def line_chart(xAxisvalue, predicatedLine, **optional_params):
    ...
    ax.set_xlabel('Time', color='white' if theme == 'black' else 'black')
    ax.set_ylabel('Value', color='white' if theme == 'black' else 'black')
...
# theme = "black"
# line_chart(xAxisvalue, predicatedLine, actualLine=actualLine, theme=theme)
...
def horizontal_waterfall(categories, values, **optional_params):
    ...
    ax.set_xlabel('Value', fontsize=12, color='black')
    ax.set_ylabel('Categories', fontsize=8, color='black')
...
# theme = 'white'
# horizontal_waterfall(categories, values, title=title, theme=theme)
...
# predicatedLine = [30, 30, 33, 28, 34, 29, 33, 28, 34, 29, 28, 33, 32]
# actualLine = [30, 30, 29, 33, 32, 29, 29, 33, 32, 29, 30, 31, 37]
# line_chart(xAxisvalue, predicatedLine, actualLine,theme='white')
...
def explanability_chart(data, **optional_params):
    ...
    ax.set_title('Horizontal Waterfall', fontdict={'fontsize': 15, 'color':  ('black' if theme != 'black'else 'white')})
    if ('xlabel' in optional_params):
        ax.set_xlabel(optional_params['xlabel'])
    if ('ylabel' in optional_params):
        ax.set_ylabel(optional_params['ylabel'])
...
# }
# explanability_chart(data,theme='white')
