...
def has_permissions(obj: DesktopObject, sub: str | None, permissions: Iterable[Permission]) -> bool:
    """
    ...
    :param permissions: an iterable of Permission enum values (required).
