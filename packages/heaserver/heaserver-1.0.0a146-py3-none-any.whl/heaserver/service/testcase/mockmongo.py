...
from typing import AsyncGenerator, Optional, List, IO, Generator, Mapping, Literal
...
class MockMongo(InMemoryDatabase):
    ...
    async def get_all(self, request: web.Request, collection: str, var_parts=None, mongoattributes=None,
                      sub: Optional[str] = None, sort: Literal[-1, 1] | None = None) -> AsyncGenerator[DesktopObjectDict, None]:
        """
