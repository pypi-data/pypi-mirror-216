    ...
    def test_glossaries_KEY(self):
        ...
        for report in REPORTS[:max_reports]:
            for g_type in [
                ...
                self.add_annotations_and_links(glossary_html, report)

    def add_annotations_and_links(self, glossary_html, report):
        if glossary_html.exists():
            ...
            #     annotated_elem = lxml.etree.parse(str(glossary_file))
            glossary.create_links()
