...
# the decode function is the same load function as torchaudio.load with soundfile backend
_SUBTYPE2DTYPE = {
    "PCM_S8": "int8",
    "PCM_U8": "uint8",
    "PCM_16": "int16",
...
class Audio(str):
    ...
    def decode(
        ...
        format: Optional[str] = None,) -> Tuple[Optional[np.ndarray], Optional[int], Optional[BaseError]]:
        ...
        with soundfile.SoundFile("audio.wav", "r") as file_:
            ...
            return waveform[0], sample_rate, None
