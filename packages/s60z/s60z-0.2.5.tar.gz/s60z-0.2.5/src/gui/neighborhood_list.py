...
""" Creation of useful global variables"""
ROOT = pathlib.Path(__file__).resolve().parent.parent.parent
logging.info(ROOT)
R = F.RESET

# Establish the use of the logger
...
def get_earfcn_values(app_data, sender, user_data):
    ...
    match test.lookup_table(freq):
        case "71":
            ...
            with dpg.window(pos=(0, 680), height=55, width=225, no_close=True, no_collapse=True, no_scrollbar=True, no_move=True, no_title_bar=True):
                dpg.add_text(
        ...
        case _:
            try:
                ...
                ulearfcn = math + 18000
                with dpg.window(pos=(0, 680), height=55, width=225, no_close=True, no_collapse=True, no_scrollbar=True, no_title_bar=True):
                    dpg.add_text(
