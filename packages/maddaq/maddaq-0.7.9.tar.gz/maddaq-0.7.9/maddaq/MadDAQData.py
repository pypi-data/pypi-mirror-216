#!/usr/bin/env python3
"""MadDAQData is a class that helps navigating the data."""
...
try:
    from MadDAQModule import MadDAQModule, ModuleDataIterator
...
try:
    ...
    from maddaq.ScanManager import ScanManager
...
class MadDAQData(object):
    """MadDAQData is the portal to the MadDAQ data.
    ...
    def __iter__(self):
        ...
        return heapq.merge(*iter(list(self.modules.values())),
                           key=operator.attrgetter('evt_time'))
