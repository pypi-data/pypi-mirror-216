...
def get_service_context_from_tracking_url_default_auth(parsed_url):
    ...
    auth = ChainedTokenCredential(
        *default_auth.credentials,
        ...
        InteractiveBrowserCredential(authority=cloud._get_authority(), tenant_id=tenant_id),
        DeviceCodeCredential(authority=cloud._get_authority(), tenant_id=tenant_id)
    )
