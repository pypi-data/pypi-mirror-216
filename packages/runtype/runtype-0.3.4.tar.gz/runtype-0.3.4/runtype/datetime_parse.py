...
And subsequently stolen from https://github.com/samuelcolvin/pydantic/blob/master/pydantic/datetime_parse.py
...
DateError = TimeError = DurationError = DateTimeError
