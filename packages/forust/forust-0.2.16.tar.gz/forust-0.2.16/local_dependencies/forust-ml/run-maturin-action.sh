...
echo "::endgroup::"
maturin publish --target x86_64-unknown-linux-gnu --username jinlow --password WasThisAnother214 --interpreter python3.11 --skip-existing --manifest-path py-forust/Cargo.toml