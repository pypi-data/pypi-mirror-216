...
class TokenizeUseGraffl(object):
    ...
    def __init__(self):
        ...
        Updated:
            27-Feb-2023
            craigtrim@gmail.com
            *   fix tokenization issue with squotes
                https://github.com/craigtrim/fast-sentence-tokenize/issues/7
        """
        pass
    ...
    def _handle_lingering_squotes(self,
        ...
        # fast-sentence-tokenize/issues/7; for tokens ending with an apostrophe (genitive form)
        if not len(squotes_pos):
            return tokens
