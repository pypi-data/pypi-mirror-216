...
Type definitions and abstract base classes used in
...
class StepLog(TypedDict):
    """Single log element used for storing
    ProcessingStep metadata associated to a single
    input element."""
