...
class CartesianWaypoint():
    def __init__(self, robot_pose: RobotPose, reference_type: ReferenceType = ReferenceType.Absolute, velocity_rel: float = 1.0, acceleration_rel: float = 1.0, jerk_rel: float = 1.0, max_dynamics: bool = False, minimum_time: typing.Optional[float] = None) -> None: ...
    @property
    def acceleration_rel(self) -> float:
        """
        :type: float
        """
    @property
    def jerk_rel(self) -> float:
        """
        :type: float
        """
    @property
    ...
    def target(self) -> RobotPose:
        ...
        """
    @property
    def velocity_rel(self) -> float:
        """
        :type: float
        """
    pass
class CartesianWaypointMotion(CartesianPoseMotion):
    def __init__(self, waypoints: typing.List[CartesianWaypoint], frame: typing.Optional[Affine] = None, velocity_rel: float = 1.0, acceleration_rel: float = 1.0, jerk_rel: float = 1.0, max_dynamics: bool = False, return_when_finished: bool = True) -> None: ...
    pass
...
class JointVelocityReaction():
    ...
    pass
class JointWaypoint():
    def __init__(self, target: numpy.ndarray[numpy.float64, _Shape[7, 1]], reference_type: ReferenceType = ReferenceType.Absolute, velocity_rel: float = 1.0, acceleration_rel: float = 1.0, jerk_rel: float = 1.0, max_dynamics: bool = False, minimum_time: typing.Optional[float] = None) -> None: ...
    @property
    def acceleration_rel(self) -> float:
        """
        :type: float
...
class JointWaypointMotion(JointPositionMotion):
    def __init__(self, waypoints: typing.List[JointWaypoint], velocity_rel: float = 1.0, acceleration_rel: float = 1.0, jerk_rel: float = 1.0, return_when_finished: bool = True) -> None: ...
    pass
class Kinematics():
    @staticmethod
...
class LinearMotion(CartesianWaypointMotion, CartesianPoseMotion):
    def __init__(self, target: RobotPose, reference_type: ReferenceType = ReferenceType.Absolute, frame: typing.Optional[Affine] = None, velocity_rel: float = 1.0, acceleration_rel: float = 1.0, jerk_rel: float = 1.0, return_when_finished: bool = True) -> None: ...
    pass
class Measure():
    @typing.overload
    ...
    @typing.overload
    def __div__(self, arg0: Measure) -> Measure: ...
    @typing.overload
    def __div__(self, arg0: float) -> Measure: ...
    @typing.overload
    ...
    def __rdiv__(self, arg0: float) -> Measure: ...
    def __repr__(self) -> str: ...
...
class ReferenceType():
    ...
    pass
class RobotInternal():
    def __init__(self, fci_hostname: str, velocity_rel: float = 1.0, acceleration_rel: float = 1.0, jerk_rel: float = 1.0, default_torque_threshold: float = 20.0, default_force_threshold: float = 30.0, controller_mode: ControllerMode = ControllerMode.JointImpedance, realtime_config: RealtimeConfig = RealtimeConfig.Enforce) -> None: ...
    @staticmethod
    ...
    @typing.overload
    def set_dynamic_rel(self, dynamic_rel: float) -> None: ...
    @typing.overload
    def set_dynamic_rel(self, velocity_rel: float, acceleration_rel: float, jerk_rel: float) -> None: ...
    ...
    def acceleration_rel(self, arg1: float) -> None:
        pass
    @property
    ...
    def jerk_rel(self) -> float:
        ...
        """
    @jerk_rel.setter
    def jerk_rel(self, arg1: float) -> None:
        pass
    @property
    ...
    def velocity_rel(self) -> float:
        ...
        """
    @velocity_rel.setter
    def velocity_rel(self, arg1: float) -> None:
        pass
    control_rate = 0.001
