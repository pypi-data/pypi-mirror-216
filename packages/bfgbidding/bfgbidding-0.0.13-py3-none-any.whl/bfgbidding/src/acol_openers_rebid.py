...
class OpenersReBid(Hand):
    ...
    def _responder_has_passed(self):
        ...
        # print(self.board.description, self.bid_one.level)
    ...
    def _rebid_after_suit_opening(self):
        ...
        #     else:
        #         raise_level = 1
        #     bid = self.next_level_bid(self.responder_bid_one.denomination, '1340', raise_level)
        else:
            bid = self._rebid_no_support()
        self.tracer(__name__, inspection(), bid, self.trace)
        return bid
    ...
    #         bid = self.next_level_bid(responders_suit, '1330', raise_level=1)
    #     else:
    #         bid = self.next_level_bid(responders_suit, '1331')
    #     self.tracer(__name__, inspection(), bid, self.trace)
    #     return bid
    ...
    def _five_four_weak_invitational(self, suit_to_bid, cannot_show_second_suit):
        ...
        #         bid = self.next_level_bid(self.second_suit, '1373')
        #     else:
        #         bid = self.next_level_bid(self.longest_suit, '1374')
    ...
    def _single_suited_uncontested(self):
        ...
        #     bid = self.next_level_bid(self.responder_bid_one.denomination, '1386')
    ...
    def _can_support_responders_major(self):
        ...
        if (self.responder_bid_one.level >= 2 and
    ...
    def _five_in_opponents_suits(self):
