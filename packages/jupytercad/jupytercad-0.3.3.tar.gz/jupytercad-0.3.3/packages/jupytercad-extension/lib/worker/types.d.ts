...
type IOperatorFunc<T> = (args: T, jcadContent: IJCadContent) => IOperatorFuncOutput | undefined;
export type IAllOperatorFunc = IOperatorFunc<IAny> | IOperatorFunc<IBox> | IOperatorFunc<ICylinder> | IOperatorFunc<ISphere> | IOperatorFunc<ICone> | IOperatorFunc<ITorus> | IOperatorFunc<ICut> | IOperatorFunc<IFuse> | IOperatorFunc<IIntersection> | IOperatorFunc<IExtrusion> | IOperatorFunc<ISketchObject>;
export type IOperatorArg = IAny & IBox & ICylinder & ISphere & ICone & ITorus & ICut & IFuse & IExtrusion & ISketchObject;
export {};
