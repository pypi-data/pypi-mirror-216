...
class EnvironmentFile:
    ...
    def convert_to_current_os_dir(cls, path: str) -> str:
        ...
        if sys.platform.startswith('win'):
            converted_path = cls.convert_windows_dir(path)
        elif sys.platform.startswith('linux') or sys.platform.startswith('darwin'):
            converted_path = cls.convert_unix_dir(path)
        else:
            converted_path = path
    ...
    @staticmethod
    def convert_unix_dir(folder_path: str) -> str:
        ...
        folder_path = folder_path.rstrip(window_dir) + window_dir
    ...
    def convert_windows_dir(folder_path: str) -> str:
        ...
        if window_dir in folder_path:
            ...
            folder_path = folder_path.lstrip(unix_dir) + unix_dir

        folder_path = folder_path.rstrip(unix_dir) + unix_dir
