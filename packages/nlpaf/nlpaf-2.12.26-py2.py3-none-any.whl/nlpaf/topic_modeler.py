...
class topic_modeler:
    ...
    def compute_coherence_values(
        ...
        os.environ[
            ...
            config.MALLET_ROOT
        )  # for windows make sure you put the mallet folder under C and unzip it
    ...
    @staticmethod
    def show_word_cloud(
        topics, limit=10, stopwords_extension=[], topic_index=range(1, 11)
    ):
    ...
    def show_doc_topic_barcharts(self):
        ...
        topic_top3words = [
            (i, topic)
            for i, topics in self.model.show_topics(formatted=False)
