...
def test_getLivneh_fluxes_case1(AOI):
    ...
    # Call function to get output
    output = shortcuts.getLivneh_fluxes(AOI, varname, startDate, endDate, verbose)
...
def test_getPolaris_case1(AOI):
    ...
    # Call function to get output
    output = shortcuts.getPolaris(AOI, varname, verbose)
...
def test_getMACA_month_case1(AOI):
    ...
    # Call function to get output
    output = shortcuts.getMACA(AOI, varname, startDate, endDate,timeRes, model, scenario, verbose)
