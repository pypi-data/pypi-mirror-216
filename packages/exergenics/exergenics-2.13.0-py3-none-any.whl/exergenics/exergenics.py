...
class ExergenicsApi:
    ...
    def getTimeNow(timestampFormat="%Y_%m_%d_%H%M") -> str:
...
class FeatureToggle:
    ...
    def __init__(self, environment: str):
        ...
        if environment not in ['local', 'staging', 'production']:
            raise ValueError('Environment parameter should only be either "local", "staging", or "production"')
    ...
    def featureIsEnabled(self, feature: str) -> bool:
