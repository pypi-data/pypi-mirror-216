...
def mask_threshold_downscale_quantile(igrid, ogrid, ivalues_true, ivalues_false, theshold_values, threshold, comparison_operator, quantile):
    return _gridpp.mask_threshold_downscale_quantile(igrid, ogrid, ivalues_true, ivalues_false, theshold_values, threshold, comparison_operator, quantile)
