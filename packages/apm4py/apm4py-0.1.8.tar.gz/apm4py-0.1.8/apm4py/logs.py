...
from apm4py.utils import create_case_semantics_from_df, create_event_semantics_from_df
        ...
        **kwargs,
        ...
        Args:
            ...
            case_attribute_semantics:
                ...
                passed.
            logId: ID if the log which content is to be replaced
            **kwargs:
                Keyword arguments passed to requests functions.
    ...
    def upload_event_log_file(
        ...
        **kwargs,
        ...
        Returns:
            The requests response of the lana api call.
        """
        with open(event_file_path, "rb") as event_file, open(
            case_file_path, "rb"
        ) as case_file, open(event_semantics_path) as event_semantics, open(
            case_semantics_path
        ) as case_semantics:
            files = {
